...
export default ComparisonDemo;`,C=s.memo(({onClick:a,label:r,renderCount:l})=>(console.log(`${r} 子组件渲染`),e.jsxs("div",{className:"p-3 bg-blue-50 rounded border border-blue-200",children:[e.jsx("p",{className:"text-sm text-blue-800 mb-2",children:r}),e.jsxs("p",{className:"text-xs text-blue-600 mb-2",children:["渲染次数: ",l]}),e.jsx("button",{onClick:a,className:"px-3 py-1 bg-blue-500 text-white rounded text-sm hover:bg-blue-600 transition-colors",children:"点击我"})]}))),I=()=>{const[a,r]=s.useState(0),[l,b]=s.useState(0),[x,o]=s.useState({with:0,without:0}),[c,v]=s.useState([]),g=i=>{const p=new Date().toLocaleTimeString();v(j=>[...j.slice(-5),`${p}: ${i}`])},u=()=>{r(a+1),g("没有 useCallback 的按钮被点击"),o(i=>({...i,without:i.without+1}))},m=s.useCallback(()=>{r(i=>i+1),g("使用 useCallback 的按钮被点击"),o(i=>({...i,with:i.with+1}))},[]),h=()=>{b(i=>i+1),g("其他状态更新，观察子组件是否重新渲染")},N=()=>{v([])},y=()=>{o({with:0,without:0}),g("重置渲染计数")};return e.jsxs("div",{className:"p-6 bg-white rounded-lg border border-gray-200",children:[e.jsxs("div",{className:"flex items-center justify-between mb-4",children:[e.jsx("h3",{className:"text-lg font-semibold text-gray-800",children:"useCallback 性能优化"}),e.jsxs("div",{className:"flex space-x-2",children:[e.jsx("button",{onClick:y,className:"px-3 py-1 bg-gray-500 text-white rounded text-sm hover:bg-gray-600 transition-colors",children:"重置计数"}),e.jsx("button",{onClick:N,className:"px-3 py-1 bg-red-500 text-white rounded text-sm hover:bg-red-600 transition-colors",children:"清空日志"})]})]}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-4 mb-6",children:[e.jsxs("div",{className:"text-center",children:[e.jsx("div",{className:"text-2xl font-bold text-blue-600 mb-1",children:a}),e.jsx("div",{className:"text-sm text-gray-500",children:"计数值"})]}),e.jsxs("div",{className:"text-center",children:[e.jsx("div",{className:"text-2xl font-bold text-green-600 mb-1",children:l}),e.jsx("div",{className:"text-sm text-gray-500",children:"其他状态"})]}),e.jsx("div",{className:"text-center",children:e.jsx("button",{onClick:h,className:"px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600 transition-colors",children:"更新其他状态"})})]}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6 mb-6",children:[e.jsx(C,{onClick:u,label:"没有 useCallback",renderCount:x.without}),e.jsx(C,{onClick:m,label:"使用 useCallback",renderCount:x.with})]}),e.jsxs("div",{className:"bg-gray-50 rounded-lg p-4",children:[e.jsx("h4",{className:"font-semibold text-gray-800 mb-2",children:"操作日志:"}),c.length===0?e.jsx("p",{className:"text-gray-500 text-sm",children:"暂无日志"}):e.jsx("div",{className:"space-y-1 max-h-32 overflow-y-auto",children:c.map((i,p)=>e.jsx("div",{className:"text-sm text-gray-700 font-mono",children:i},p))})]}),e.jsx("div",{className:"mt-4 p-3 bg-yellow-50 rounded border border-yellow-200",children:e.jsx("p",{className:"text-sm text-yellow-800",children:'💡 点击"更新其他状态"按钮，观察哪个子组件会重新渲染。使用 useCallback 的组件不会重新渲染。'})})]})},$=`import React, { useCallback, useState } from 'react';
...
export default UseCallbackDemo;`,T=s.memo(({items:a,filter:r,multiplier:l})=>{console.log("ExpensiveList 组件渲染");const b=s.useMemo(()=>{console.log("执行昂贵的计算...");let o=0;for(let c=0;c<1e6;c++)o+=c;return o*l},[l]),x=s.useMemo(()=>(console.log("处理列表数据..."),a.filter(o=>r==="even"?o%2===0:r==="odd"?o%2===1:!0).map(o=>o*l).slice(0,10)),[a,r,l]);return e.jsxs("div",{className:"p-4 bg-purple-50 rounded border border-purple-200",children:[e.jsx("h4",{className:"font-semibold text-purple-800 mb-2",children:"计算结果"}),e.jsxs("p",{className:"text-sm text-purple-700 mb-2",children:["昂贵计算结果: ",b.toLocaleString()]}),e.jsx("p",{className:"text-sm text-purple-700 mb-2",children:"处理后的列表 (前10项):"}),e.jsx("div",{className:"grid grid-cols-5 gap-1",children:x.map((o,c)=>e.jsx("div",{className:"px-2 py-1 bg-purple-100 rounded text-xs text-center",children:o},c))})]})}),D=()=>{const[a,r]=s.useState(()=>Array.from({length:100},(t,n)=>n+1)),[l,b]=s.useState("all"),[x,o]=s.useState(1),[c,v]=s.useState(0),[g,u]=s.useState([]),m=t=>{const n=new Date().toLocaleTimeString();u(d=>[...d.slice(-5),`${n}: ${t}`])},h=s.useMemo(()=>{console.log("计算统计信息..."),m("重新计算统计信息");const t=a.reduce((k,M)=>k+M,0),n=t/a.length,d=Math.max(...a),w=Math.min(...a);return{sum:t,average:n,max:d,min:w,count:a.length}},[a]),N=s.useMemo(()=>(console.log("过滤数据..."),m(`应用过滤器: ${l}`),a.filter(t=>l==="even"?t%2===0:l==="odd"?t%2===1:!0)),[a,l]),y=()=>{const t=Array.from({length:10},()=>Math.floor(Math.random()*100)+1);r(n=>[...n,...t]),m(`添加了 ${t.length} 个随机项`)},i=()=>{r([]),m("清空所有项")},p=()=>{r(Array.from({length:100},(t,n)=>n+1)),m("重置为初始数据")},j=()=>{v(t=>t+1),m("更新无关状态 (不应触发重新计算)")},f=()=>{u([])};return e.jsxs("div",{className:"p-6 bg-white rounded-lg border border-gray-200",children:[e.jsxs("div",{className:"flex items-center justify-between mb-4",children:[e.jsx("h3",{className:"text-lg font-semibold text-gray-800",children:"useMemo 性能优化"}),e.jsx("button",{onClick:f,className:"px-3 py-1 bg-red-500 text-white rounded text-sm hover:bg-red-600 transition-colors",children:"清空日志"})]}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6 mb-6",children:[e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{children:[e.jsx("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:"数据操作:"}),e.jsxs("div",{className:"flex flex-wrap gap-2",children:[e.jsx("button",{onClick:y,className:"px-3 py-1 bg-blue-500 text-white rounded text-sm hover:bg-blue-600 transition-colors",children:"添加随机项"}),e.jsx("button",{onClick:p,className:"px-3 py-1 bg-green-500 text-white rounded text-sm hover:bg-green-600 transition-colors",children:"重置数据"}),e.jsx("button",{onClick:i,className:"px-3 py-1 bg-red-500 text-white rounded text-sm hover:bg-red-600 transition-colors",children:"清空数据"})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:"过滤器:"}),e.jsx("div",{className:"flex space-x-2",children:["all","even","odd"].map(t=>e.jsx("button",{onClick:()=>{b(t),m(`切换过滤器到: ${t}`)},className:`px-3 py-1 rounded text-sm transition-colors ${l===t?"bg-purple-500 text-white":"bg-gray-200 text-gray-700 hover:bg-gray-300"}`,children:t==="all"?"全部":t==="even"?"偶数":"奇数"},t))})]}),e.jsxs("div",{children:[e.jsxs("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:["乘数: ",x]}),e.jsx("input",{type:"range",min:"1",max:"10",value:x,onChange:t=>{const n=Number(t.target.value);o(n),m(`设置乘数为: ${n}`)},className:"w-full"})]}),e.jsxs("div",{children:[e.jsxs("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:["无关状态: ",c]}),e.jsx("button",{onClick:j,className:"px-3 py-1 bg-gray-500 text-white rounded text-sm hover:bg-gray-600 transition-colors",children:"更新无关状态"})]})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{className:"p-4 bg-blue-50 rounded border border-blue-200",children:[e.jsx("h4",{className:"font-semibold text-blue-800 mb-2",children:"统计信息 (useMemo)"}),e.jsxs("div",{className:"grid grid-cols-2 gap-2 text-sm",children:[e.jsxs("div",{children:["总数: ",h.count]}),e.jsxs("div",{children:["总和: ",h.sum]}),e.jsxs("div",{children:["平均: ",h.average.toFixed(2)]}),e.jsxs("div",{children:["最大: ",h.max]}),e.jsxs("div",{children:["最小: ",h.min]}),e.jsxs("div",{children:["过滤后: ",N.length]})]})]}),e.jsx(T,{items:N,filter:l,multiplier:x})]})]}),e.jsxs("div",{className:"bg-gray-50 rounded-lg p-4",children:[e.jsx("h4",{className:"font-semibold text-gray-800 mb-2",children:"操作日志:"}),g.length===0?e.jsx("p",{className:"text-gray-500 text-sm",children:"暂无日志"}):e.jsx("div",{className:"space-y-1 max-h-32 overflow-y-auto",children:g.map((t,n)=>e.jsx("div",{className:"text-sm text-gray-700 font-mono",children:t},n))})]}),e.jsx("div",{className:"mt-4 p-3 bg-green-50 rounded border border-green-200",children:e.jsx("p",{className:"text-sm text-green-800",children:'💡 点击"更新无关状态"按钮，观察统计信息不会重新计算。useMemo 只有在依赖项变化时才重新计算。'})})]})},W=`import React, { useMemo, useState } from 'react';
