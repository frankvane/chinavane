import{r as o,j as e}from"./index-D5aG88J3.js";import{C as P}from"./ComponentTemplate-DZf1RTVD.js";const h=typeof window>"u",w=n=>new Promise(r=>setTimeout(r,n)),E=n=>{const r=["技术","产品","设计","运营","管理"],t=["React","TypeScript","Node.js","GraphQL","Docker","AWS","MongoDB","Redis"];return Array.from({length:n},(m,l)=>({id:l+1,title:`深入理解 ${t[l%t.length]} 的核心概念与实践应用`,content:`这是一篇关于 ${t[l%t.length]} 的详细文章。文章从基础概念开始，逐步深入到高级特性和实际应用场景。内容包括：
