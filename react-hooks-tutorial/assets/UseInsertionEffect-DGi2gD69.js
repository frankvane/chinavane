import{r as s,j as e}from"./index-CKH9Ek1I.js";import{C}from"./ComponentTemplate-B8dTsNLj.js";const w=()=>{const[n,g]=s.useState(!1),[a,x]=s.useState([]),[d,r]=s.useState(0),l=(t,i)=>{const f={id:Date.now()+Math.random(),message:t,timestamp:new Date().toLocaleTimeString(),type:i};x(h=>[...h.slice(-4),f])};s.useInsertionEffect(()=>{const t=`
      .dynamic-demo-box {
    ...
    `,r=document.createElement("style");return r.id=`style-${n.className}`,r.textContent=d,document.head.appendChild(r),()=>{const l=document.getElementById(`style-${n.className}`);l&&l.remove()}},[n.className,a]);const x=d=>{d.stopPropagation(),g(n.id)};return e.jsxs("div",{className:n.className,children:[e.jsx("button",{className:"remove-btn",onClick:x,title:"移除组件",children:"×"}),e.jsx("div",{className:"text-lg mb-1",children:n.name}),e.jsxs("div",{className:"text-xs opacity-90",children:["类名: ",n.className]}),e.jsx("div",{className:"text-xs opacity-75 mt-2",children:"点击移除 | 悬停查看效果"})]})},$=()=>{const[n,g]=s.useState("light"),[a,x]=s.useState(!1);s.useInsertionEffect(()=>{const r=document.getElementById("dynamic-theme-styles");r&&r.remove();const l={light:`
    ...
    `};s.useInsertionEffect(()=>{if(!n)return;const o=performance.now(),c=document.getElementById("performance-test-insertion");c&&c.remove();const u=f(),p=document.createElement("style");p.id="performance-test-insertion",p.textContent=u,document.head.appendChild(p);const v=performance.now()-o;return i("useInsertionEffect",v),()=>{const b=document.getElementById("performance-test-insertion");b&&b.remove()}},[n,a,i]),s.useEffect(()=>{if(n)return;const o=performance.now(),c=document.getElementById("performance-test-effect");c&&c.remove();const u=f(),p=document.createElement("style");p.id="performance-test-effect",p.textContent=u,document.head.appendChild(p);const v=performance.now()-o;return i("useEffect",v),()=>{const b=document.getElementById("performance-test-effect");b&&b.remove()}},[n,a,i]),s.useEffect(()=>{r([...t.current]),m(!1)},[a,n]);const h=()=>{m(!0),x(o=>o+1)},E=()=>{g(o=>!o)},j=()=>{r([]),t.current=[]},N=o=>{const c=d.filter(p=>p.hookType===o);return c.length===0?0:(c.reduce((p,y)=>p+y.executionTime,0)/c.length).toFixed(3)},S=o=>d.filter(c=>c.hookType===o).length;return e.jsxs("div",{className:"space-y-6",children:[e.jsxs("div",{className:"bg-gray-50 p-4 rounded-lg",children:[e.jsxs("div",{className:"flex flex-wrap gap-3 items-center mb-4",children:[e.jsxs("button",{onClick:E,className:`px-4 py-2 rounded-lg font-medium transition-colors ${n?"bg-red-500 text-white hover:bg-red-600":"bg-blue-500 text-white hover:bg-blue-600"}`,children:["当前: ",n?"useInsertionEffect":"useEffect"]}),e.jsx("button",{onClick:h,className:"px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors font-medium",disabled:l,children:l?"⏳ 执行中...":"🔄 触发重新渲染"}),e.jsx("button",{onClick:j,className:"px-4 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600 transition-colors font-medium",children:"🗑️ 清空数据"})]}),e.jsxs("div",{className:"grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm",children:[e.jsxs("div",{className:"text-gray-600",children:["渲染次数: ",e.jsx("span",{className:"font-mono font-bold",children:a})]}),e.jsxs("div",{className:"text-gray-600",children:["当前 Hook: ",e.jsx("span",{className:"font-mono font-bold",children:n?"useInsertionEffect":"useEffect"})]}),e.jsxs("div",{className:"text-gray-600",children:["状态: ",e.jsx("span",{className:"font-mono font-bold",children:l?"执行中":"空闲"})]})]})]}),e.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-2 gap-6",children:[e.jsxs("div",{className:"space-y-4",children:[e.jsx("h3",{className:"text-lg font-semibold text-gray-800",children:"样式演示区域"}),e.jsxs("div",{className:"performance-test-box",children:[e.jsx("div",{className:"text-xl mb-2",children:"⚡ 性能测试演示"}),e.jsxs("div",{className:"text-sm opacity-90",children:["使用 ",n?"useInsertionEffect":"useEffect"]}),e.jsxs("div",{className:"text-xs opacity-75 mt-2",children:["渲染 #",a]})]})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx("h3",{className:"text-lg font-semibold text-gray-800",children:"性能对比数据"}),e.jsxs("div",{className:"grid grid-cols-2 gap-4",children:[e.jsxs("div",{className:"bg-red-50 p-4 rounded-lg border border-red-200",children:[e.jsx("h4",{className:"text-sm font-semibold text-red-800 mb-2",children:"useInsertionEffect"}),e.jsxs("div",{className:"space-y-1 text-sm",children:[e.jsxs("div",{children:["执行次数: ",e.jsx("span",{className:"font-mono",children:S("useInsertionEffect")})]}),e.jsxs("div",{children:["平均耗时: ",e.jsxs("span",{className:"font-mono",children:[N("useInsertionEffect"),"ms"]})]})]})]}),e.jsxs("div",{className:"bg-blue-50 p-4 rounded-lg border border-blue-200",children:[e.jsx("h4",{className:"text-sm font-semibold text-blue-800 mb-2",children:"useEffect"}),e.jsxs("div",{className:"space-y-1 text-sm",children:[e.jsxs("div",{children:["执行次数: ",e.jsx("span",{className:"font-mono",children:S("useEffect")})]}),e.jsxs("div",{children:["平均耗时: ",e.jsxs("span",{className:"font-mono",children:[N("useEffect"),"ms"]})]})]})]})]}),e.jsxs("div",{className:"bg-gray-900 text-green-400 p-4 rounded-lg font-mono text-sm max-h-48 overflow-y-auto",children:[e.jsx("div",{className:"text-gray-400 mb-2",children:"最近执行记录:"}),d.length===0?e.jsx("div",{className:"text-gray-500",children:"暂无执行记录..."}):d.map((o,c)=>e.jsxs("div",{className:"mb-1",children:[e.jsxs("span",{className:"text-gray-500",children:["[",o.timestamp,"]"]}),e.jsx("span",{className:`ml-2 ${o.hookType==="useInsertionEffect"?"text-red-400":"text-blue-400"}`,children:o.hookType}),e.jsxs("span",{className:"text-yellow-400 ml-2",children:[o.executionTime.toFixed(3),"ms"]})]},c))]})]})]}),e.jsxs("div",{className:"text-sm text-gray-600 bg-blue-50 p-4 rounded-lg",children:[e.jsx("strong",{children:"💡 性能对比说明:"}),e.jsxs("ul",{className:"mt-2 space-y-1 list-disc list-inside",children:[e.jsx("li",{children:"useInsertionEffect 在 DOM 变更前执行，时机更早"}),e.jsx("li",{children:"useEffect 在渲染完成后异步执行，可能有轻微延迟"}),e.jsx("li",{children:"对于样式注入，useInsertionEffect 能避免样式闪烁"}),e.jsx("li",{children:"性能差异通常很小，但在复杂场景下会更明显"})]})]})]})},T=`import React, {
  useEffect,
  useInsertionEffect,
  useLayoutEffect,
  useState,
