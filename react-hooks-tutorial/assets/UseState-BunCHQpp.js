...
`,f=()=>{const[s,t]=d.useState(()=>{console.log("🔥 执行昂贵的初始化计算...");let a=0;for(let l=0;l<1e6;l++)a+=Math.random();return Math.floor(a)}),[i,o]=d.useState(Math.floor(Math.random()*1e3)),r=x.useRef(0);r.current+=1;const u=()=>{console.log("🔄 重新生成普通值"),o(Math.floor(Math.random()*1e3))},m=()=>{console.log("🔄 重新生成昂贵值"),t(()=>{console.log("🔥 重新执行昂贵计算...");let a=0;for(let l=0;l<1e6;l++)a+=Math.random();return Math.floor(a)})};return e.jsxs("div",{className:"p-6 bg-white rounded-lg border border-gray-200",children:[e.jsxs("div",{className:"flex items-center justify-between mb-4",children:[e.jsx("h3",{className:"text-lg font-semibold text-gray-800",children:"惰性初始化对比"}),e.jsxs("span",{className:"text-sm text-gray-500",children:["渲染次数: ",r.current]})]}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-4",children:[e.jsxs("div",{className:"p-4 bg-blue-50 rounded-lg border border-blue-200",children:[e.jsx("h4",{className:"font-semibold text-blue-800 mb-2",children:"惰性初始化值"}),e.jsx("div",{className:"text-2xl font-bold text-blue-600 mb-3",children:s}),e.jsx("button",{onClick:m,className:"px-3 py-1 bg-blue-500 text-white rounded text-sm hover:bg-blue-600 transition-colors",children:"重新计算"}),e.jsx("p",{className:"text-xs text-blue-600 mt-2",children:"初始化函数只在首次渲染时执行"})]}),e.jsxs("div",{className:"p-4 bg-green-50 rounded-lg border border-green-200",children:[e.jsx("h4",{className:"font-semibold text-green-800 mb-2",children:"普通初始化值"}),e.jsx("div",{className:"text-2xl font-bold text-green-600 mb-3",children:i}),e.jsx("button",{onClick:u,className:"px-3 py-1 bg-green-500 text-white rounded text-sm hover:bg-green-600 transition-colors",children:"重新生成"}),e.jsx("p",{className:"text-xs text-green-600 mt-2",children:"每次渲染都会重新计算初始值"})]})]}),e.jsx("div",{className:"mt-4 p-3 bg-yellow-50 rounded border border-yellow-200",children:e.jsx("p",{className:"text-sm text-yellow-800",children:"💡 打开浏览器控制台查看初始化函数的执行情况"})})]})},y=`import React, { useState } from "react";\r
\r
// 惰性初始化示例\r
