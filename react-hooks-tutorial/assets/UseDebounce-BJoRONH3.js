import{r as s,j as e}from"./index-nevtk0dH.js";import{C as P}from"./ComponentTemplate-CQT_cNgc.js";function T(a,m){const[i,j]=s.useState(a);return s.useEffect(()=>{const l=setTimeout(()=>{j(a)},m);return()=>{clearTimeout(l)}},[a,m]),i}function E(a,m,i={}){const[j,l]=s.useState(a),[N,o]=s.useState(!1),u=s.useRef(null),c=s.useRef(null),g=s.useRef(0),x=s.useRef(0),h=s.useRef(!0),{leading:v=!1,trailing:y=!0,maxWait:n}=i,d=s.useCallback(()=>{l(a),o(!1),x.current=Date.now()},[a]),w=s.useCallback(()=>{x.current=Date.now(),v?d():o(!0)},[v,d]),C=s.useCallback(p=>{const $=p-g.current,L=p-x.current,R=m-$;return n!==void 0?Math.min(R,n-L):R},[m,n]),b=s.useCallback(p=>{const $=p-g.current,L=p-x.current;return g.current===0||$>=m||$<0||n!==void 0&&L>=n},[m,n]),D=s.useCallback(()=>{u.current=null,y&&g.current!==0?d():o(!1),g.current=0},[y,d]),k=s.useCallback(()=>{const p=Date.now();if(b(p))D();else{const $=C(p);u.current=setTimeout(k,$)}},[b,D,C]),r=s.useCallback(()=>{u.current&&(clearTimeout(u.current),u.current=null),c.current&&(clearTimeout(c.current),c.current=null),g.current=0,x.current=0,h.current=!0,o(!1)},[]),S=s.useCallback(()=>{u.current&&(d(),r())},[d,r]);return s.useEffect(()=>{const p=Date.now();return g.current=p,b(p)&&(h.current&&(h.current=!1,w()),n!==void 0&&(c.current=setTimeout(()=>{N&&d()},n))),!u.current&&y&&(u.current=setTimeout(k,m)),()=>{u.current&&clearTimeout(u.current),c.current&&clearTimeout(c.current)}},[a,m,b,w,y,k,n,N,d]),{debouncedValue:j,isPending:N,cancel:r,flush:S}}const z=()=>{const[a,m]=s.useState(""),[i,j]=s.useState(500),[l,N]=s.useState(!1),[o,u]=s.useState(!0),[c,g]=s.useState(void 0),{debouncedValue:x,isPending:h,cancel:v,flush:y}=E(a,i,{leading:l,trailing:o,maxWait:c}),[n,d]=s.useState([]),[w,C]=s.useState([]),b=t=>{const f=new Date().toLocaleTimeString();d(V=>[...V.slice(-9),`${f}: ${t}`])},D=t=>{const f=new Date().toLocaleTimeString();C(V=>[...V.slice(-9),`${f}: ${t}`])};s.useEffect(()=>{x&&D(`API调用: 搜索 "${x}"`)},[x]);const k=t=>{m(t),b(`输入: "${t}"`)},r=()=>{v(),b("取消防抖")},S=()=>{y(),b("立即执行防抖")},p=t=>{j(t),b(`延迟改为: ${t}ms`)},$=t=>{N(t),b(`${t?"启用":"禁用"}前缘执行`)},L=t=>{u(t),b(`${t?"启用":"禁用"}后缘执行`)},R=t=>{const f=t===""?void 0:Number(t);g(f),b(`最大等待时间: ${f?f+"ms":"无限制"}`)},A=()=>{m(""),d([]),C([]),v(),b("清空所有内容")},I=()=>{d([]),C([])};return e.jsxs("div",{className:"p-6 bg-white rounded-lg border border-gray-200",children:[e.jsxs("div",{className:"flex items-center justify-between mb-4",children:[e.jsx("h3",{className:"text-lg font-semibold text-gray-800",children:"高级防抖演示"}),e.jsxs("div",{className:"space-x-2",children:[e.jsx("button",{onClick:r,disabled:!h,className:"px-3 py-1 bg-orange-500 text-white rounded text-sm hover:bg-orange-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors",children:"取消防抖"}),e.jsx("button",{onClick:S,disabled:!h,className:"px-3 py-1 bg-green-500 text-white rounded text-sm hover:bg-green-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors",children:"立即执行"}),e.jsx("button",{onClick:A,className:"px-3 py-1 bg-red-500 text-white rounded text-sm hover:bg-red-600 transition-colors",children:"清空所有"}),e.jsx("button",{onClick:I,className:"px-3 py-1 bg-gray-500 text-white rounded text-sm hover:bg-gray-600 transition-colors",children:"清空日志"})]})]}),e.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-2 gap-6",children:[e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{children:[e.jsx("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:"搜索输入:"}),e.jsx("input",{type:"text",value:a,onChange:t=>k(t.target.value),placeholder:"输入搜索内容...",className:"w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"}),e.jsxs("div",{className:"flex items-center justify-between mt-1",children:[e.jsxs("p",{className:"text-sm text-gray-600",children:['当前输入: "',a,'"']}),e.jsxs("div",{className:`flex items-center space-x-2 px-2 py-1 rounded text-xs ${h?"bg-yellow-100 text-yellow-800":"bg-green-100 text-green-800"}`,children:[e.jsx("div",{className:`w-2 h-2 rounded-full ${h?"bg-yellow-500 animate-pulse":"bg-green-500"}`}),e.jsx("span",{children:h?"等待中":"已同步"})]})]})]}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-4",children:[e.jsxs("div",{children:[e.jsxs("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:["延迟时间: ",i,"ms"]}),e.jsx("input",{type:"range",min:"100",max:"2000",step:"100",value:i,onChange:t=>p(Number(t.target.value)),className:"w-full"})]}),e.jsxs("div",{children:[e.jsx("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:"最大等待时间 (ms):"}),e.jsx("input",{type:"number",value:c||"",onChange:t=>R(t.target.value),placeholder:"无限制",min:"100",step:"100",className:"w-full px-3 py-1 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"})]})]}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-4",children:[e.jsxs("label",{className:"flex items-center space-x-2",children:[e.jsx("input",{type:"checkbox",checked:l,onChange:t=>$(t.target.checked),className:"text-blue-500 focus:ring-blue-500"}),e.jsx("span",{className:"text-sm text-gray-700",children:"前缘执行 (立即执行第一次)"})]}),e.jsxs("label",{className:"flex items-center space-x-2",children:[e.jsx("input",{type:"checkbox",checked:o,onChange:t=>L(t.target.checked),className:"text-blue-500 focus:ring-blue-500"}),e.jsx("span",{className:"text-sm text-gray-700",children:"后缘执行 (延迟后执行)"})]})]}),e.jsxs("div",{className:"p-3 bg-purple-50 rounded border border-purple-200",children:[e.jsx("h4",{className:"font-semibold text-purple-800 mb-2",children:"防抖状态:"}),e.jsxs("div",{className:"text-sm text-purple-700 space-y-1",children:[e.jsxs("p",{children:[e.jsx("strong",{children:"原始值:"}),' "',a,'"']}),e.jsxs("p",{children:[e.jsx("strong",{children:"防抖值:"}),' "',x,'"']}),e.jsxs("p",{children:[e.jsx("strong",{children:"等待状态:"})," ",h?"等待中":"已完成"]}),e.jsxs("p",{children:[e.jsx("strong",{children:"配置:"}),l&&" 前缘",o&&" 后缘",c&&` 最大${c}ms`]})]})]})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{children:[e.jsx("h4",{className:"font-semibold text-gray-700 mb-3",children:"操作日志:"}),e.jsx("div",{className:"bg-gray-50 rounded-lg p-3 h-40 overflow-y-auto",children:n.length===0?e.jsx("p",{className:"text-gray-500 text-sm",children:"开始操作查看日志"}):e.jsx("div",{className:"space-y-1",children:n.map((t,f)=>e.jsx("div",{className:"text-sm font-mono text-gray-700",children:t},f))})})]}),e.jsxs("div",{children:[e.jsx("h4",{className:"font-semibold text-gray-700 mb-3",children:"API调用记录:"}),e.jsx("div",{className:"bg-blue-50 rounded-lg p-3 h-32 overflow-y-auto",children:w.length===0?e.jsx("p",{className:"text-blue-500 text-sm",children:"暂无API调用"}):e.jsx("div",{className:"space-y-1",children:w.map((t,f)=>e.jsx("div",{className:"text-sm font-mono text-blue-700",children:t},f))})})]}),e.jsxs("div",{className:"p-3 bg-teal-50 rounded border border-teal-200",children:[e.jsx("h4",{className:"font-semibold text-teal-800 mb-2",children:"配置说明:"}),e.jsxs("ul",{className:"text-sm text-teal-700 space-y-1",children:[e.jsxs("li",{children:[e.jsx("strong",{children:"前缘执行:"})," 第一次变化时立即执行"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"后缘执行:"})," 延迟时间后执行"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"最大等待:"})," 超过此时间强制执行"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"取消:"})," 取消等待中的执行"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"立即执行:"})," 跳过等待立即执行"]})]})]})]})]}),e.jsx("div",{className:"mt-4 p-3 bg-cyan-50 rounded border border-cyan-200",children:e.jsx("p",{className:"text-sm text-cyan-800",children:"💡 高级防抖提供了更多控制选项：前缘/后缘执行、最大等待时间、手动取消和立即执行，适用于复杂的交互场景。"})})]})},W=`import React, { useState, useEffect } from 'react';
