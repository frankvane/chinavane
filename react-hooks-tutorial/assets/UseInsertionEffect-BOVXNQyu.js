import{r as s,j as e}from"./index-nevtk0dH.js";import{C}from"./ComponentTemplate-CQT_cNgc.js";const w=()=>{const[n,f]=s.useState(!1),[a,p]=s.useState([]),[d,r]=s.useState(0),l=(t,i)=>{const g={id:Date.now()+Math.random(),message:t,timestamp:new Date().toLocaleTimeString(),type:i};p(h=>[...h.slice(-4),g])};s.useInsertionEffect(()=>{const t=`
      .dynamic-demo-box {
