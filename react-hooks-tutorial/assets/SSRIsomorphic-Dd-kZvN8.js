import{r as o,j as e}from"./index-nevtk0dH.js";import{C as P}from"./ComponentTemplate-CQT_cNgc.js";const h=typeof window>"u",j=n=>new Promise(a=>setTimeout(a,n)),E=n=>{const a=["技术","产品","设计","运营","管理"],t=["React","TypeScript","Node.js","GraphQL","Docker","AWS","MongoDB","Redis"];return Array.from({length:n},(m,l)=>({id:l+1,title:`深入理解 ${t[l%t.length]} 的核心概念与实践应用`,content:`这是一篇关于 ${t[l%t.length]} 的详细文章。文章从基础概念开始，逐步深入到高级特性和实际应用场景。内容包括：
...
通过本文，读者可以全面掌握 ${t[l%t.length]} 的使用方法和优化技巧。`,author:`技术专家 ${l%5+1}`,publishDate:new Date(2023,l%12,l%28+1).toISOString().split("T")[0],category:a[l%a.length],tags:[t[l%t.length],t[(l+1)%t.length]],readTime:Math.floor(Math.random()*15)+5,views:Math.floor(Math.random()*1e4)+100,likes:Math.floor(Math.random()*500)+10}))},H=n=>({id:n,name:`技术专家 ${n}`,avatar:`https://api.dicebear.com/7.x/avataaars/svg?seed=${n}`,bio:`资深${["前端","后端","全栈","架构","DevOps"][n%5]}工程师，专注于现代Web技术栈的研究与实践。`,followers:Math.floor(Math.random()*5e3)+100,following:Math.floor(Math.random()*1e3)+50,articles:Math.floor(Math.random()*100)+10}),A=async(n=1,a)=>{await j(500+Math.random()*500);const t=E(100),m=a?t.filter(s=>s.category===a):t,l=(n-1)*10;return{articles:m.slice(l,l+10),total:m.length}},I=async n=>(await j(300+Math.random()*300),E(100).find(t=>t.id===n)||null),R=async n=>(await j(200+Math.random()*200),H(n)),C=(n,a)=>{if(h)return;let t=document.querySelector(`meta[name="${n}"]`);t||(t=document.createElement("meta"),t.name=n,document.head.appendChild(t)),t.content=a},N=(n,a)=>{if(h)return;let t=document.querySelector(`meta[property="${n}"]`);t||(t=document.createElement("meta"),t.setAttribute("property",n),document.head.appendChild(t)),t.content=a},_=n=>{if(h)return;let a=document.querySelector('link[rel="canonical"]');a||(a=document.createElement("link"),a.rel="canonical",document.head.appendChild(a)),a.href=n},O=n=>{var a;return h?null:((a=window.__SSR_DATA__)==null?void 0:a[n])||null},S=(n,a,t=[])=>{const[m,l]=o.useState(null),[r,s]=o.useState(!h),[p,d]=o.useState(null),u=o.useRef(!1),g=o.useRef(n),b=o.useCallback(()=>{u.current=!1,s(!0),d(null)},[]);return o.useEffect(()=>{if(h)return;g.current!==n&&(u.current=!1,l(null),d(null),g.current=n);const y=O(n);if(y&&!u.current){l(y),s(!1),u.current=!0;return}u.current||(s(!0),d(null),a().then(c=>{l(c),s(!1),u.current=!0}).catch(c=>{d(c.message||"数据获取失败"),s(!1)}))},[n,a,...t]),{data:m,loading:r,error:p,refetch:b}},M=n=>{o.useEffect(()=>{h||(document.title=n.title,C("description",n.description),C("keywords",n.keywords.join(", ")),N("og:title",n.title),N("og:description",n.description),N("og:image",n.ogImage),N("og:url",n.canonicalUrl),_(n.canonicalUrl))},[n])},$=()=>{const[n,a]=o.useState(!1);return o.useEffect(()=>{a(!0)},[]),n},L=()=>{const n=o.useRef(new Map),a=o.useRef(new Set),t=o.useCallback(async(s,p)=>{if(n.current.has(s)||a.current.has(s))return n.current.get(s)||null;a.current.add(s);try{const d=await p();return n.current.set(s,d),a.current.delete(s),d}catch(d){return a.current.delete(s),console.error(`预加载失败 [${s}]:`,d),null}},[]),m=o.useCallback(s=>n.current.get(s)||null,[]),l=o.useCallback(s=>{s?n.current.delete(s):n.current.clear()},[]),r=o.useCallback(s=>a.current.has(s),[]);return{preload:t,getCache:m,clearCache:l,isLoading:r}},U=()=>{const[n,a]=o.useState(""),[t,m]=o.useState(1),l=$(),{data:r,loading:s,error:p,refetch:d}=S(`articles_${n}_${t}`,()=>A(t,n||void 0),[n,t]),u=o.useMemo(()=>({title:n?`${n}分类文章 - 技术博客`:"技术博客 - 最新文章",description:n?`浏览${n}分类下的所有技术文章，包含最新的技术趋势和实践经验。`:"技术博客汇集了最新的前端、后端、架构等技术文章，助您提升技术水平。",keywords:n?[n,"技术文章","编程","开发"]:["技术博客","前端","后端","全栈开发","React","Node.js"],ogImage:"https://example.com/og-image.jpg",canonicalUrl:`https://example.com/articles${n?`?category=${n}`:""}`}),[n]);M(u);const g=["技术","产品","设计","运营","管理"],b=o.useCallback(c=>{console.log("切换分类:",c),a(c),m(1)},[]),f=o.useCallback(c=>{console.log("切换页面:",c),m(c)},[]),y=`articles_${n}_${t}`;return console.log("当前缓存键:",y),console.log("当前分类:",n),console.log("当前页面:",t),console.log("文章数据:",r),e.jsx("div",{className:"space-y-6",children:e.jsxs("div",{className:"bg-white p-6 rounded-lg border border-gray-200",children:[e.jsx("h3",{className:"text-lg font-semibold mb-4",children:"基础 SSR 演示"}),e.jsxs("div",{className:"mb-4 p-3 bg-blue-50 border border-blue-200 rounded",children:[e.jsxs("div",{className:"flex items-center space-x-2",children:[e.jsx("div",{className:`w-3 h-3 rounded-full ${l?"bg-green-500":"bg-yellow-500"}`}),e.jsx("span",{className:"text-sm font-medium",children:l?"客户端已水合":"服务端渲染中"})]}),e.jsx("p",{className:"text-xs text-blue-700 mt-1",children:l?"页面已完成水合，所有交互功能可用":"页面正在从服务端渲染状态转换到客户端状态"})]}),e.jsxs("div",{className:"mb-6",children:[e.jsx("h4",{className:"font-medium text-gray-800 mb-3",children:"文章分类"}),e.jsxs("div",{className:"flex flex-wrap gap-2",children:[e.jsx("button",{onClick:()=>b(""),className:`px-3 py-1 text-sm rounded-full border transition-colors ${n===""?"bg-blue-500 text-white border-blue-500":"bg-white text-gray-700 border-gray-300 hover:border-gray-400"}`,children:"全部"}),g.map(c=>e.jsx("button",{onClick:()=>b(c),className:`px-3 py-1 text-sm rounded-full border transition-colors ${n===c?"bg-blue-500 text-white border-blue-500":"bg-white text-gray-700 border-gray-300 hover:border-gray-400"}`,children:c},c))]})]}),e.jsxs("div",{className:"mb-6",children:[e.jsxs("div",{className:"flex items-center justify-between mb-3",children:[e.jsx("h4",{className:"font-medium text-gray-800",children:"文章列表"}),s&&e.jsxs("div",{className:"flex items-center text-sm text-blue-600",children:[e.jsx("div",{className:"animate-spin rounded-full h-4 w-4 border-b-2 border-blue-500 mr-2"}),"加载中..."]})]}),p?e.jsxs("div",{className:"p-4 bg-red-50 border border-red-200 rounded text-red-800",children:[p,e.jsx("button",{onClick:d,className:"ml-2 text-sm bg-red-600 text-white px-2 py-1 rounded hover:bg-red-700",children:"重试"})]}):r!=null&&r.articles?e.jsx("div",{className:"space-y-4",children:r.articles.map(c=>e.jsxs("div",{className:"p-4 bg-gray-50 border border-gray-200 rounded-lg",children:[e.jsxs("div",{className:"flex items-start justify-between mb-2",children:[e.jsx("h5",{className:"font-semibold text-gray-900 flex-1",children:c.title}),e.jsx("span",{className:"text-xs bg-blue-100 text-blue-800 px-2 py-1 rounded ml-2",children:c.category})]}),e.jsx("p",{className:"text-sm text-gray-600 mb-3 line-clamp-2",children:c.content.split(`
`)[0]}),e.jsxs("div",{className:"flex items-center justify-between text-xs text-gray-500",children:[e.jsxs("div",{className:"flex items-center space-x-4",children:[e.jsxs("span",{children:["作者: ",c.author]}),e.jsx("span",{children:c.publishDate}),e.jsxs("span",{children:[c.readTime," 分钟阅读"]})]}),e.jsxs("div",{className:"flex items-center space-x-3",children:[e.jsxs("span",{children:["👁 ",c.views]}),e.jsxs("span",{children:["👍 ",c.likes]})]})]}),e.jsx("div",{className:"flex space-x-2 mt-2",children:c.tags.map(v=>e.jsx("span",{className:"text-xs bg-gray-200 text-gray-700 px-2 py-1 rounded",children:v},v))})]},c.id))}):e.jsx("div",{className:"p-8 bg-gray-50 border border-gray-200 rounded text-center text-gray-600",children:l?"暂无文章":"正在加载文章..."})]}),r&&e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{className:"text-sm text-gray-600",children:["共 ",r.total," 篇文章"]}),e.jsxs("div",{className:"flex space-x-2",children:[e.jsx("button",{onClick:()=>f(Math.max(1,t-1)),disabled:t===1||s,className:"px-3 py-1 text-sm border border-gray-300 rounded hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed",children:"上一页"}),e.jsx("span",{className:"px-3 py-1 text-sm bg-blue-100 text-blue-800 rounded",children:t}),e.jsx("button",{onClick:()=>f(t+1),disabled:t*10>=r.total||s,className:"px-3 py-1 text-sm border border-gray-300 rounded hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed",children:"下一页"})]})]}),e.jsxs("div",{className:"mt-6 p-3 bg-green-50 border border-green-200 rounded",children:[e.jsx("h4",{className:"font-medium text-green-800 mb-2",children:"SSR 基础功能："}),e.jsxs("div",{className:"text-sm text-green-700 space-y-1",children:[e.jsx("p",{children:"• 服务端预渲染：提升首屏加载速度和 SEO"}),e.jsx("p",{children:"• 数据预取：在服务端获取数据，减少客户端请求"}),e.jsx("p",{children:"• 水合过程：客户端接管服务端渲染的 HTML"}),e.jsx("p",{children:"• SEO 优化：动态生成 meta 标签和结构化数据"})]})]})]})})},q=()=>{const[n,a]=o.useState(null),t=$(),{preload:m,getCache:l}=L(),{data:r,loading:s,error:p}=S(n?`article_${n}`:"",()=>n?I(n):Promise.resolve(null),[n]),{data:d,loading:u}=S(r?`user_${r.author}`:"",()=>{var i;return r?R(parseInt(((i=r.author.match(/\d+/))==null?void 0:i[0])||"1")):Promise.resolve(null)},[r==null?void 0:r.author]),{data:g,loading:b}=S("recent_articles",()=>A(1),[]),f=o.useMemo(()=>r?{title:`${r.title} - 技术博客`,description:r.content.substring(0,160)+"...",keywords:[...r.tags,"技术文章","编程"],ogImage:`https://example.com/og-article-${r.id}.jpg`,canonicalUrl:`https://example.com/article/${r.id}`}:{title:"同构应用演示 - 技术博客",description:"展示同构应用的服务端渲染和客户端水合过程，包含动态路由和数据获取。",keywords:["同构应用","SSR","服务端渲染","React"],ogImage:"https://example.com/og-isomorphic.jpg",canonicalUrl:"https://example.com/isomorphic-demo"},[r]);M(f);const y=o.useCallback(async i=>{l(`user_${i}`)||await m(`user_${i}`,()=>R(i))},[m,l]),c=o.useCallback(i=>{a(i),t&&window.history.pushState({},"",`/article/${i}`)},[t]),v=o.useCallback(()=>{a(null),t&&window.history.pushState({},"","/")},[t]);return e.jsx("div",{className:"space-y-6",children:e.jsxs("div",{className:"bg-white p-6 rounded-lg border border-gray-200",children:[e.jsx("h3",{className:"text-lg font-semibold mb-4",children:"同构应用演示"}),e.jsxs("div",{className:"mb-6 grid grid-cols-1 md:grid-cols-3 gap-4",children:[e.jsxs("div",{className:"p-3 bg-blue-50 border border-blue-200 rounded",children:[e.jsxs("div",{className:"flex items-center space-x-2 mb-1",children:[e.jsx("div",{className:`w-3 h-3 rounded-full ${t?"bg-green-500":"bg-yellow-500"}`}),e.jsx("span",{className:"text-sm font-medium",children:"水合状态"})]}),e.jsx("p",{className:"text-xs text-blue-700",children:t?"已完成水合":"正在水合中"})]}),e.jsxs("div",{className:"p-3 bg-green-50 border border-green-200 rounded",children:[e.jsxs("div",{className:"flex items-center space-x-2 mb-1",children:[e.jsx("div",{className:`w-3 h-3 rounded-full ${typeof window<"u"?"bg-green-500":"bg-red-500"}`}),e.jsx("span",{className:"text-sm font-medium",children:"运行环境"})]}),e.jsx("p",{className:"text-xs text-green-700",children:typeof window<"u"?"客户端":"服务端"})]}),e.jsxs("div",{className:"p-3 bg-purple-50 border border-purple-200 rounded",children:[e.jsxs("div",{className:"flex items-center space-x-2 mb-1",children:[e.jsx("div",{className:`w-3 h-3 rounded-full ${n?"bg-blue-500":"bg-gray-400"}`}),e.jsx("span",{className:"text-sm font-medium",children:"当前路由"})]}),e.jsx("p",{className:"text-xs text-purple-700",children:n?`/article/${n}`:"/"})]})]}),e.jsx("div",{className:"mb-6",children:e.jsxs("nav",{className:"flex space-x-4",children:[e.jsx("button",{onClick:v,className:`px-3 py-2 text-sm rounded transition-colors ${n?"bg-gray-100 text-gray-700 hover:bg-gray-200":"bg-blue-500 text-white"}`,children:"首页"}),n&&e.jsx("button",{onClick:v,className:"px-3 py-2 text-sm bg-gray-100 text-gray-700 rounded hover:bg-gray-200",children:"← 返回列表"})]})}),n?e.jsx("div",{className:"space-y-6",children:s?e.jsxs("div",{className:"p-8 bg-gray-50 border border-gray-200 rounded text-center",children:[e.jsx("div",{className:"animate-spin rounded-full h-8 w-8 border-b-2 border-blue-500 mx-auto mb-2"}),e.jsx("p",{className:"text-gray-600",children:"加载文章详情..."})]}):p?e.jsx("div",{className:"p-4 bg-red-50 border border-red-200 rounded text-red-800",children:p}):r?e.jsxs("div",{className:"space-y-6",children:[e.jsxs("div",{className:"border-b border-gray-200 pb-6",children:[e.jsx("h1",{className:"text-2xl font-bold text-gray-900 mb-4",children:r.title}),e.jsxs("div",{className:"flex items-center justify-between text-sm text-gray-600",children:[e.jsxs("div",{className:"flex items-center space-x-4",children:[e.jsxs("span",{children:["作者: ",r.author]}),e.jsx("span",{children:r.publishDate}),e.jsxs("span",{children:[r.readTime," 分钟阅读"]})]}),e.jsxs("div",{className:"flex items-center space-x-3",children:[e.jsxs("span",{children:["👁 ",r.views]}),e.jsxs("span",{children:["👍 ",r.likes]})]})]}),e.jsxs("div",{className:"flex space-x-2 mt-3",children:[e.jsx("span",{className:"text-xs bg-blue-100 text-blue-800 px-2 py-1 rounded",children:r.category}),r.tags.map(i=>e.jsx("span",{className:"text-xs bg-gray-200 text-gray-700 px-2 py-1 rounded",children:i},i))]})]}),e.jsx("div",{className:"prose max-w-none",children:e.jsx("div",{className:"whitespace-pre-line text-gray-800 leading-relaxed",children:r.content})}),u?e.jsx("div",{className:"p-4 bg-gray-50 border border-gray-200 rounded",children:e.jsxs("div",{className:"animate-pulse flex space-x-4",children:[e.jsx("div",{className:"rounded-full bg-gray-300 h-12 w-12"}),e.jsxs("div",{className:"flex-1 space-y-2",children:[e.jsx("div",{className:"h-4 bg-gray-300 rounded w-1/4"}),e.jsx("div",{className:"h-3 bg-gray-300 rounded w-3/4"})]})]})}):d?e.jsxs("div",{className:"p-4 bg-gray-50 border border-gray-200 rounded",children:[e.jsx("h3",{className:"font-semibold text-gray-900 mb-3",children:"关于作者"}),e.jsxs("div",{className:"flex items-start space-x-4",children:[e.jsx("img",{src:d.avatar,alt:d.name,className:"w-12 h-12 rounded-full"}),e.jsxs("div",{className:"flex-1",children:[e.jsx("h4",{className:"font-medium text-gray-900",children:d.name}),e.jsx("p",{className:"text-sm text-gray-600 mb-2",children:d.bio}),e.jsxs("div",{className:"flex items-center space-x-4 text-xs text-gray-500",children:[e.jsxs("span",{children:["关注者: ",d.followers]}),e.jsxs("span",{children:["关注中: ",d.following]}),e.jsxs("span",{children:["文章: ",d.articles]})]})]})]})]}):null]}):e.jsx("div",{className:"p-8 bg-gray-50 border border-gray-200 rounded text-center text-gray-600",children:"文章不存在"})}):e.jsxs("div",{className:"space-y-6",children:[e.jsx("h2",{className:"text-xl font-semibold text-gray-900",children:"最新文章"}),b?e.jsx("div",{className:"space-y-4",children:Array.from({length:5}).map((i,x)=>e.jsxs("div",{className:"p-4 bg-gray-50 border border-gray-200 rounded animate-pulse",children:[e.jsx("div",{className:"h-4 bg-gray-300 rounded mb-2"}),e.jsx("div",{className:"h-3 bg-gray-300 rounded mb-2"}),e.jsx("div",{className:"h-3 bg-gray-300 rounded w-3/4"})]},x))}):g!=null&&g.articles?e.jsx("div",{className:"space-y-4",children:g.articles.slice(0,8).map(i=>e.jsxs("div",{className:"p-4 bg-gray-50 border border-gray-200 rounded-lg hover:shadow-md transition-shadow cursor-pointer",onClick:()=>c(i.id),onMouseEnter:()=>{var w;const x=parseInt(((w=i.author.match(/\d+/))==null?void 0:w[0])||"1");y(x)},children:[e.jsxs("div",{className:"flex items-start justify-between mb-2",children:[e.jsx("h3",{className:"font-semibold text-gray-900 flex-1 hover:text-blue-600 transition-colors",children:i.title}),e.jsx("span",{className:"text-xs bg-blue-100 text-blue-800 px-2 py-1 rounded ml-2",children:i.category})]}),e.jsx("p",{className:"text-sm text-gray-600 mb-3 line-clamp-2",children:i.content.split(`
