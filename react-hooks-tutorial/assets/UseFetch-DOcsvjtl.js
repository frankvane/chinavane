import{r as o,j as e}from"./index-D5aG88J3.js";import{C as $}from"./ComponentTemplate-DZf1RTVD.js";function w(r,N={}){const[t,m]=o.useState(null),[l,i]=o.useState(!1),[n,g]=o.useState(null),d=o.useRef(null),{method:y="GET",headers:h={},body:u,dependencies:a=[],enabled:b=!0}=N,v=o.useCallback(async(f=!1)=>{if(!(!b&&!f)){d.current&&d.current.abort(),d.current=new AbortController,i(!0),g(null);try{if(await new Promise(s=>setTimeout(s,1e3+Math.random()*1e3)),Math.random()<.2)throw new Error("网络请求失败");let x;if(r.includes("users")){const s=r.split("/").pop();s&&s!=="users"?x={id:parseInt(s),name:`用户${s}`,email:`user${s}@example.com`,avatar:`https://api.dicebear.com/7.x/avataaars/svg?seed=${s}`,status:"active",joinDate:new Date().toISOString(),lastLogin:new Date().toISOString()}:x={users:Array.from({length:5},(p,j)=>({id:j+1,name:`用户${j+1}`,email:`user${j+1}@example.com`,avatar:`https://api.dicebear.com/7.x/avataaars/svg?seed=${j+1}`}))}}else r.includes("posts")?x={posts:Array.from({length:3},(s,p)=>({id:p+1,title:`文章标题${p+1}`,content:`这是第${p+1}篇文章的内容，包含了丰富的信息和有趣的观点。`,author:`作者${p+1}`,createdAt:new Date(Date.now()-p*24*60*60*1e3).toISOString()}))}:x={message:"请求成功",timestamp:new Date().toISOString()};m(x)}catch(x){x.name!=="AbortError"&&g(x.message||"请求失败")}finally{i(!1)}}},[r,y,JSON.stringify(h),JSON.stringify(u),b,...a]),c=o.useCallback(()=>{v(!0)},[v]);return o.useEffect(()=>(v(),()=>{d.current&&d.current.abort()}),[v]),{data:t,loading:l,error:n,refetch:c}}const C=()=>{const[r,N]=o.useState("/api/users"),{data:t,loading:m,error:l,refetch:i}=w(r),[n,g]=o.useState([]),d=a=>{const b=new Date().toLocaleTimeString();g(v=>[...v.slice(-9),`${b}: ${a}`])};o.useEffect(()=>{m?d(`开始请求: ${r}`):l?d(`请求失败: ${l}`):t&&d("请求成功: 获取到数据")},[m,l,t,r]);const y=a=>{N(a),d(`切换端点: ${a}`)},h=()=>{d("手动重新请求"),i()},u=()=>{g([])};return e.jsxs("div",{className:"p-6 bg-white rounded-lg border border-gray-200",children:[e.jsxs("div",{className:"flex items-center justify-between mb-4",children:[e.jsx("h3",{className:"text-lg font-semibold text-gray-800",children:"基础用法演示"}),e.jsxs("div",{className:"space-x-2",children:[e.jsx("button",{onClick:h,disabled:m,className:"px-3 py-1 bg-blue-500 text-white rounded text-sm hover:bg-blue-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors",children:m?"请求中...":"重新请求"}),e.jsx("button",{onClick:u,className:"px-3 py-1 bg-gray-500 text-white rounded text-sm hover:bg-gray-600 transition-colors",children:"清空日志"})]})]}),e.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-2 gap-6",children:[e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{children:[e.jsx("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:"选择 API 端点:"}),e.jsx("div",{className:"space-y-2",children:[{value:"/api/users",label:"用户列表"},{value:"/api/posts",label:"文章列表"},{value:"/api/data",label:"通用数据"}].map(a=>e.jsxs("label",{className:"flex items-center space-x-2",children:[e.jsx("input",{type:"radio",name:"endpoint",value:a.value,checked:r===a.value,onChange:b=>y(b.target.value),className:"text-blue-500 focus:ring-blue-500"}),e.jsx("span",{className:"text-sm text-gray-700",children:a.label})]},a.value))})]}),e.jsx("div",{className:"flex items-center space-x-4",children:e.jsxs("div",{className:`flex items-center space-x-2 px-3 py-1 rounded-full text-sm ${m?"bg-blue-100 text-blue-800":l?"bg-red-100 text-red-800":"bg-green-100 text-green-800"}`,children:[e.jsx("div",{className:`w-2 h-2 rounded-full ${m?"bg-blue-500 animate-pulse":l?"bg-red-500":"bg-green-500"}`}),e.jsx("span",{children:m?"请求中...":l?"请求失败":"请求成功"})]})}),e.jsxs("div",{className:"border border-gray-200 rounded-lg",children:[e.jsx("div",{className:"bg-gray-50 px-3 py-2 border-b border-gray-200",children:e.jsx("h4",{className:"font-semibold text-gray-700",children:"响应数据"})}),e.jsx("div",{className:"p-3 max-h-60 overflow-y-auto",children:m?e.jsx("div",{className:"flex items-center justify-center h-20",children:e.jsx("div",{className:"animate-spin rounded-full h-6 w-6 border-b-2 border-blue-500"})}):l?e.jsxs("div",{className:"text-red-600 text-sm",children:[e.jsx("p",{className:"font-semibold",children:"错误信息:"}),e.jsx("p",{children:l})]}):t?e.jsxs("div",{className:"space-y-2",children:[t.users&&e.jsxs("div",{children:[e.jsx("h5",{className:"font-semibold text-gray-800 mb-2",children:"用户列表:"}),e.jsx("div",{className:"space-y-2",children:t.users.map(a=>e.jsxs("div",{className:"flex items-center space-x-3 p-2 bg-gray-50 rounded",children:[e.jsx("img",{src:a.avatar,alt:a.name,className:"w-8 h-8 rounded-full"}),e.jsxs("div",{children:[e.jsx("p",{className:"font-medium text-gray-900",children:a.name}),e.jsx("p",{className:"text-sm text-gray-600",children:a.email})]})]},a.id))})]}),t.posts&&e.jsxs("div",{children:[e.jsx("h5",{className:"font-semibold text-gray-800 mb-2",children:"文章列表:"}),e.jsx("div",{className:"space-y-2",children:t.posts.map(a=>e.jsxs("div",{className:"p-3 bg-gray-50 rounded",children:[e.jsx("h6",{className:"font-medium text-gray-900",children:a.title}),e.jsx("p",{className:"text-sm text-gray-600 mt-1",children:a.content}),e.jsxs("div",{className:"flex items-center justify-between mt-2 text-xs text-gray-500",children:[e.jsxs("span",{children:["作者: ",a.author]}),e.jsx("span",{children:new Date(a.createdAt).toLocaleDateString()})]})]},a.id))})]}),t.message&&e.jsxs("div",{children:[e.jsx("h5",{className:"font-semibold text-gray-800 mb-2",children:"响应信息:"}),e.jsxs("div",{className:"p-2 bg-gray-50 rounded",children:[e.jsx("p",{className:"text-gray-700",children:t.message}),e.jsxs("p",{className:"text-sm text-gray-500 mt-1",children:["时间: ",new Date(t.timestamp).toLocaleString()]})]})]})]}):e.jsx("p",{className:"text-gray-500 text-sm",children:"暂无数据"})})]})]}),e.jsxs("div",{children:[e.jsx("h4",{className:"font-semibold text-gray-700 mb-3",children:"请求日志:"}),e.jsx("div",{className:"bg-gray-50 rounded-lg p-3 min-h-[300px]",children:n.length===0?e.jsx("p",{className:"text-gray-500 text-sm",children:"选择端点或重新请求查看日志"}):e.jsx("div",{className:"space-y-1 max-h-60 overflow-y-auto",children:n.map((a,b)=>e.jsx("div",{className:"text-sm font-mono text-gray-700",children:a},b))})}),e.jsxs("div",{className:"mt-4 p-3 bg-blue-50 rounded border border-blue-200",children:[e.jsx("h4",{className:"font-semibold text-blue-800 mb-2",children:"请求状态:"}),e.jsxs("div",{className:"text-sm text-blue-700 space-y-1",children:[e.jsxs("p",{children:[e.jsx("strong",{children:"端点:"})," ",r]}),e.jsxs("p",{children:[e.jsx("strong",{children:"状态:"})," ",m?"请求中":l?"失败":"成功"]}),e.jsxs("p",{children:[e.jsx("strong",{children:"数据:"})," ",t?"已加载":"无数据"]}),e.jsxs("p",{children:[e.jsx("strong",{children:"错误:"})," ",l||"无"]})]})]})]})]}),e.jsx("div",{className:"mt-4 p-3 bg-green-50 rounded border border-green-200",children:e.jsx("p",{className:"text-sm text-green-800",children:"💡 useFetch Hook 封装了数据获取逻辑，提供 loading、error、data 状态和 refetch 方法，支持自动请求取消。"})})]})},S=`import React, { useState, useEffect } from 'react';\r
