import{r as t,j as e}from"./index-D5aG88J3.js";import{C as T}from"./ComponentTemplate-DZf1RTVD.js";const p={linear:n=>n,easeInQuad:n=>n*n,easeOutQuad:n=>n*(2-n),easeInOutQuad:n=>n<.5?2*n*n:-1+(4-2*n)*n,easeInCubic:n=>n*n*n,easeOutCubic:n=>--n*n*n+1,easeInOutCubic:n=>n<.5?4*n*n*n:(n-1)*(2*n-2)*(2*n-2)+1,easeInSine:n=>1-Math.cos(n*Math.PI/2),easeOutSine:n=>Math.sin(n*Math.PI/2),easeInOutSine:n=>-(Math.cos(Math.PI*n)-1)/2,bounce:n=>n<1/2.75?7.5625*n*n:n<2/2.75?7.5625*(n-=1.5/2.75)*n+.75:n<2.5/2.75?7.5625*(n-=2.25/2.75)*n+.9375:7.5625*(n-=2.625/2.75)*n+.984375,elastic:n=>{if(n===0)return 0;if(n===1)return 1;const d=.3,s=d/4;return-(Math.pow(2,10*(n-=1))*Math.sin((n-s)*(2*Math.PI)/d))}};function S(n,d,s){const[l,r]=t.useState({isPlaying:!1,progress:0,value:n,iteration:0}),i=t.useRef(null),m=t.useRef(null),u=t.useRef(0),o=t.useRef(0),c=t.useRef("forward"),{duration:g,easing:v=p.linear,delay:P=0,loop:y=!1,direction:w="normal",onComplete:C,onUpdate:A}=s,a=t.useCallback(f=>{m.current||(m.current=f-u.current);const h=f-m.current-P;if(h<0){i.current=requestAnimationFrame(a);return}let N=Math.min(h/g,1);(w==="reverse"||w==="alternate"&&c.current==="backward")&&(N=1-N);const I=v(N),F=n+(d-n)*I;r(R=>({...R,progress:h/g,value:F})),A==null||A(F),h>=g?(o.current+=1,y===!0||typeof y=="number"&&o.current<y?(w==="alternate"&&(c.current=c.current==="forward"?"backward":"forward"),m.current=null,u.current=0,r(R=>({...R,iteration:o.current})),i.current=requestAnimationFrame(a)):(r(R=>({...R,isPlaying:!1,progress:1,value:w==="reverse"?n:d,iteration:o.current})),C==null||C())):i.current=requestAnimationFrame(a)},[n,d,g,v,P,y,w,C,A]),b=t.useCallback(()=>{l.isPlaying||(r(f=>({...f,isPlaying:!0})),m.current=null,i.current=requestAnimationFrame(a))},[a,l.isPlaying]),j=t.useCallback(()=>{i.current&&(cancelAnimationFrame(i.current),i.current=null),r(f=>({...f,isPlaying:!1}))},[]),x=t.useCallback(()=>{j(),m.current=null,u.current=0,o.current=0,c.current="forward",r({isPlaying:!1,progress:0,value:n,iteration:0})},[j,n]);return t.useEffect(()=>()=>{i.current&&cancelAnimationFrame(i.current)},[]),[l,{start:b,stop:j,reset:x}]}const q=()=>{const[n,{start:d,stop:s,reset:l}]=S(0,200,{duration:1e3,easing:p.bounce,loop:!0,direction:"alternate"});return e.jsxs("div",{className:"max-w-sm mx-auto p-4 bg-white rounded-lg border",children:[e.jsx("h3",{className:"text-lg font-semibold mb-4",children:"弹跳球动画"}),e.jsx("div",{className:"relative h-48 bg-gray-100 rounded mb-4 overflow-hidden",children:e.jsx("div",{className:"absolute w-8 h-8 bg-red-500 rounded-full transition-all duration-75",style:{left:"50%",transform:`translate(-50%, ${n.value}px)`,boxShadow:"0 2px 4px rgba(0,0,0,0.2)"}})}),e.jsxs("div",{className:"mb-4 text-sm space-y-1",children:[e.jsxs("div",{children:["状态: ",n.isPlaying?"🎬 播放中":"⏸️ 已暂停"]}),e.jsxs("div",{children:["进度: ",Math.round(n.progress*100),"%"]}),e.jsxs("div",{children:["位置: ",Math.round(n.value),"px"]}),e.jsxs("div",{children:["循环次数: ",n.iteration]})]}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx("button",{onClick:d,disabled:n.isPlaying,className:"flex-1 bg-green-500 text-white py-2 rounded text-sm hover:bg-green-600 disabled:opacity-50",children:"开始"}),e.jsx("button",{onClick:s,disabled:!n.isPlaying,className:"flex-1 bg-red-500 text-white py-2 rounded text-sm hover:bg-red-600 disabled:opacity-50",children:"停止"}),e.jsx("button",{onClick:l,className:"flex-1 bg-gray-500 text-white py-2 rounded text-sm hover:bg-gray-600",children:"重置"})]})]})},V=`import React from 'react';
...
};`,$=()=>{const[n,d]=t.useState("easeInOutQuad"),[s,l]=t.useState(!1),[r,i]=t.useState(0),[m,u]=t.useState(0),o=t.useRef(null),c=t.useRef(null),g=a=>{c.current||(c.current=a);const b=a-c.current,x=Math.min(b/3e3,1);i(x);const f=p[n](x),h=800,N=24,I=16+h-N,F=16+N+f*(I-(16+N));if(u(F),x<1)o.current=requestAnimationFrame(g);else{l(!1),i(1);const O=16+800-24;u(O)}},v=()=>{if(s)return;l(!0),i(0);const b=16+24;u(b),c.current=null,o.current=requestAnimationFrame(g)},P=()=>{o.current&&(cancelAnimationFrame(o.current),o.current=null),l(!1)},y=()=>{P(),i(0);const b=16+24;u(b),c.current=null};t.useEffect(()=>{y()},[n]),t.useEffect(()=>{const a=setTimeout(()=>{v()},1e3);return()=>{clearTimeout(a),o.current&&cancelAnimationFrame(o.current)}},[]);const A=(a=>{const b=[],j=p[a];for(let x=0;x<=100;x++){const f=x/100,h=j(f);b.push({x,y:h*100})}return b})(n).map((a,b)=>`${b===0?"M":"L"} ${a.x} ${100-a.y}`).join(" ");return e.jsxs("div",{className:"max-w-4xl mx-auto p-6 bg-white rounded-lg border shadow-sm",children:[e.jsx("h3",{className:"text-xl font-semibold mb-6 text-center text-gray-800",children:"缓动函数对比演示"}),e.jsxs("div",{className:"mb-6",children:[e.jsx("label",{className:"block text-sm font-medium mb-3 text-gray-700",children:"选择缓动函数:"}),e.jsx("div",{className:"grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-2",children:Object.keys(p).map(a=>e.jsx("button",{onClick:()=>d(a),disabled:s,className:`px-3 py-2 text-xs rounded border transition-colors ${n===a?"bg-blue-500 text-white border-blue-500":"bg-gray-50 text-gray-700 border-gray-300 hover:bg-gray-100"} ${s?"opacity-50 cursor-not-allowed":""}`,children:a},a))})]}),e.jsxs("div",{className:"mb-6 p-4 bg-gray-50 rounded-lg",children:[e.jsx("h4",{className:"text-sm font-medium mb-3 text-gray-700",children:"缓动函数曲线"}),e.jsx("div",{className:"relative h-40 bg-white border rounded overflow-hidden",children:e.jsxs("svg",{className:"w-full h-full",viewBox:"0 0 100 100",preserveAspectRatio:"none",children:[e.jsx("defs",{children:e.jsx("pattern",{id:"grid",width:"10",height:"10",patternUnits:"userSpaceOnUse",children:e.jsx("path",{d:"M 10 0 L 0 0 0 10",fill:"none",stroke:"#e5e7eb",strokeWidth:"0.5"})})}),e.jsx("rect",{width:"100",height:"100",fill:"url(#grid)"}),e.jsx("path",{d:A,fill:"none",stroke:"#3b82f6",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"}),e.jsx("circle",{cx:r*100,cy:100-p[n](r)*100,r:"4",fill:"#ef4444",stroke:"white",strokeWidth:"2"})]})})]}),e.jsx("div",{className:"mb-6",children:e.jsxs("div",{className:"relative h-48 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg border overflow-hidden",children:[e.jsx("div",{className:"absolute top-12 w-12 h-12 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full shadow-lg",style:{left:`${m}px`,transform:"translateX(-50%)"}}),e.jsx("div",{className:"absolute top-18 left-4 right-4 h-2 bg-gray-200",children:e.jsx("div",{className:"h-full bg-gradient-to-r from-blue-400 to-purple-400 transition-all duration-100",style:{width:`${r*100}%`}})}),e.jsxs("div",{className:"absolute bottom-6 left-6 right-6",children:[e.jsx("div",{className:"text-sm text-gray-600 mb-2",children:"缓动效果进度"}),e.jsx("div",{className:"h-3 bg-gray-200 rounded-full overflow-hidden",children:e.jsx("div",{className:"h-full bg-gradient-to-r from-green-400 to-green-600 transition-all duration-100",style:{width:`${p[n](r)*100}%`}})}),e.jsxs("div",{className:"text-sm text-gray-500 mt-2",children:["时间进度: ",Math.round(r*100),"% | 缓动进度:"," ",Math.round(p[n](r)*100),"%"]})]})]})}),e.jsxs("div",{className:"grid grid-cols-2 md:grid-cols-5 gap-4 mb-6",children:[e.jsxs("div",{className:"text-center p-4 bg-blue-50 rounded-lg border border-blue-200",children:[e.jsx("div",{className:"text-sm text-blue-600 font-medium",children:"缓动函数"}),e.jsx("div",{className:"text-xs text-blue-800 mt-1 font-mono",children:n})]}),e.jsxs("div",{className:"text-center p-4 bg-green-50 rounded-lg border border-green-200",children:[e.jsx("div",{className:"text-sm text-green-600 font-medium",children:"时间进度"}),e.jsxs("div",{className:"text-lg text-green-800 mt-1 font-bold",children:[Math.round(r*100),"%"]})]}),e.jsxs("div",{className:"text-center p-4 bg-purple-50 rounded-lg border border-purple-200",children:[e.jsx("div",{className:"text-sm text-purple-600 font-medium",children:"缓动进度"}),e.jsxs("div",{className:"text-lg text-purple-800 mt-1 font-bold",children:[Math.round(p[n](r)*100),"%"]})]}),e.jsxs("div",{className:"text-center p-4 bg-orange-50 rounded-lg border border-orange-200",children:[e.jsx("div",{className:"text-sm text-orange-600 font-medium",children:"当前位置"}),e.jsxs("div",{className:"text-lg text-orange-800 mt-1 font-bold",children:[Math.round(m),"px"]})]}),e.jsxs("div",{className:"text-center p-4 bg-red-50 rounded-lg border border-red-200",children:[e.jsx("div",{className:"text-sm text-red-600 font-medium",children:"状态"}),e.jsx("div",{className:"text-lg text-red-800 mt-1 font-bold",children:s?"播放中":"已停止"})]})]}),e.jsxs("div",{className:"flex gap-3 mb-6",children:[e.jsx("button",{onClick:v,disabled:s,className:"flex-1 bg-blue-500 text-white py-3 rounded-lg text-sm font-medium hover:bg-blue-600 disabled:opacity-50 transition-colors",children:s?"播放中...":"开始动画演示"}),e.jsx("button",{onClick:P,disabled:!s,className:"flex-1 bg-red-500 text-white py-3 rounded-lg text-sm font-medium hover:bg-red-600 disabled:opacity-50 transition-colors",children:"停止"}),e.jsx("button",{onClick:y,className:"flex-1 bg-gray-500 text-white py-3 rounded-lg text-sm font-medium hover:bg-gray-600 transition-colors",children:"重置"})]}),!s&&r===0&&e.jsx("div",{className:"mb-6 p-4 bg-blue-50 rounded-lg border border-blue-200",children:e.jsx("div",{className:"text-sm text-blue-800 text-center",children:'💡 点击"开始动画演示"按钮开始演示，或等待1秒后自动开始'})}),e.jsxs("div",{className:"p-4 bg-yellow-50 rounded-lg border border-yellow-200",children:[e.jsx("h4",{className:"text-sm font-medium text-yellow-800 mb-3",children:"缓动函数说明:"}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-2 text-xs text-yellow-700",children:[e.jsxs("div",{children:["• ",e.jsx("strong",{children:"linear"}),": 线性变化，速度恒定"]}),e.jsxs("div",{children:["• ",e.jsx("strong",{children:"easeIn"}),": 慢开始，快结束"]}),e.jsxs("div",{children:["• ",e.jsx("strong",{children:"easeOut"}),": 快开始，慢结束"]}),e.jsxs("div",{children:["• ",e.jsx("strong",{children:"easeInOut"}),": 慢开始，快中间，慢结束"]}),e.jsxs("div",{children:["• ",e.jsx("strong",{children:"bounce"}),": 弹跳效果"]}),e.jsxs("div",{children:["• ",e.jsx("strong",{children:"elastic"}),": 弹性效果"]})]})]})]})},W=`import React, { useEffect, useRef, useState } from "react";
