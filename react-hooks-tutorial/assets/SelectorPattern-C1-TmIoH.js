import{a as v,j as e,r as c,R as f}from"./index-D5aG88J3.js";import{C as y}from"./ComponentTemplate-DZf1RTVD.js";const w=`import React, { useState } from 'react';
...
}`,j=`import React, { createContext, useContext, useEffect, useState, useRef } from 'react';\r
...
}`,k={user:{id:1,name:"John Doe",email:"john@example.com",avatar:v},theme:"light",posts:[{id:1,title:"第一篇文章",content:"这是第一篇文章的内容",author:"John Doe"},{id:2,title:"第二篇文章",content:"这是第二篇文章的内容",author:"John Doe"}],loading:!1};function C(t,r){switch(r.type){case"UPDATE_USER":return{...t,user:{...t.user,...r.payload}};case"TOGGLE_THEME":return{...t,theme:t.theme==="light"?"dark":"light"};case"ADD_POST":return{...t,posts:[...t.posts,r.payload]};case"TOGGLE_LOADING":return{...t,loading:!t.loading};default:return t}}function P(t,r){if(t===r)return!0;if(t==null||r==null||typeof t!="object"||typeof r!="object")return!1;const n=Object.keys(t),s=Object.keys(r);if(n.length!==s.length)return!1;for(const o of n)if(!s.includes(o)||t[o]!==r[o])return!1;return!0}function N(){let t=k;const r=new Map;return{getState:()=>t,dispatch:i=>{const a=C(t,i);a!==t&&(t=a,r.forEach((l,d)=>{const p=d(t);l.forEach(({callback:g,lastValue:h},S)=>{P(p,h)||(l[S].lastValue=p,g())})}))},subscribe:(i,a)=>{const l=i(t);r.has(i)||r.set(i,[]);const d=r.get(i),p={callback:a,lastValue:l};return d.push(p),()=>{const g=d.indexOf(p);g>-1&&(d.splice(g,1),d.length===0&&r.delete(i))}}}}const T=N(),b=c.createContext(null);function E({children:t}){return e.jsx(b.Provider,{value:T,children:t})}function u(t){const r=c.useContext(b);if(!r)throw new Error("useSelector must be used within a StoreProvider");const[n,s]=c.useState(()=>t(r.getState())),o=c.useRef(t),i=c.useRef(n);return o.current=t,i.current=n,c.useEffect(()=>r.subscribe(o.current,()=>{const l=o.current(r.getState());s(l)}),[r]),n}function x(){const t=c.useContext(b);if(!t)throw new Error("useDispatch must be used within a StoreProvider");return t.dispatch}function m(t){const r=f.useRef(0);return r.current+=1,f.useEffect(()=>{console.log(`${t} 渲染次数: ${r.current}`)}),r.current}function R(){const t=u(o=>o.user),r=x(),n=m("UserProfile"),s=()=>{r({type:"UPDATE_USER",payload:{name:`用户 ${Date.now().toString().slice(-4)}`,email:`user${Date.now().toString().slice(-4)}@example.com`}})};return e.jsxs("div",{className:"component-card",children:[e.jsxs("h3",{children:["用户信息 (渲染: ",n,")"]}),e.jsxs("div",{className:"user-info",children:[e.jsx("img",{src:t.avatar,alt:"头像",className:"avatar"}),e.jsxs("div",{children:[e.jsxs("p",{children:[e.jsx("strong",{children:"姓名:"})," ",t.name]}),e.jsxs("p",{children:[e.jsx("strong",{children:"邮箱:"})," ",t.email]})]})]}),e.jsx("button",{onClick:s,className:"btn btn-primary",children:"更新用户信息"})]})}function D(){const t=u(o=>o.theme),r=x(),n=m("ThemeSettings"),s=()=>{r({type:"TOGGLE_THEME"})};return e.jsxs("div",{className:`component-card theme-${t}`,children:[e.jsxs("h3",{children:["主题设置 (渲染: ",n,")"]}),e.jsxs("p",{children:["当前主题: ",e.jsx("strong",{children:t==="light"?"浅色":"深色"})]}),e.jsx("button",{onClick:s,className:"btn btn-secondary",children:"切换主题"})]})}function A(){const t=u(a=>a.posts),r=x(),n=m("PostList"),[s,o]=c.useState(""),i=()=>{if(s.trim()){const a={id:Date.now(),title:s,content:`这是《${s}》的内容`,author:"当前用户"};r({type:"ADD_POST",payload:a}),o("")}};return e.jsxs("div",{className:"component-card",children:[e.jsxs("h3",{children:["文章列表 (渲染: ",n,")"]}),e.jsxs("div",{className:"post-input",children:[e.jsx("input",{type:"text",value:s,onChange:a=>o(a.target.value),placeholder:"输入文章标题",className:"input"}),e.jsx("button",{onClick:i,className:"btn btn-success",children:"添加文章"})]}),e.jsx("div",{className:"posts",children:t.map(a=>e.jsxs("div",{className:"post-item",children:[e.jsx("h4",{children:a.title}),e.jsx("p",{children:a.content}),e.jsxs("small",{children:["作者: ",a.author]})]},a.id))})]})}function L(){const t=u(o=>o.loading),r=x(),n=m("LoadingIndicator"),s=()=>{r({type:"TOGGLE_LOADING"})};return e.jsxs("div",{className:"component-card",children:[e.jsxs("h3",{children:["加载状态 (渲染: ",n,")"]}),e.jsx("div",{className:"loading-status",children:t?e.jsxs("div",{className:"loading-spinner",children:[e.jsx("div",{className:"spinner"}),e.jsx("span",{children:"加载中..."})]}):e.jsx("span",{className:"status-idle",children:"空闲状态"})}),e.jsx("button",{onClick:s,className:"btn btn-warning",children:"切换加载状态"})]})}function M(){const t=u(n=>n),r=m("FullStateComponent");return e.jsxs("div",{className:"component-card full-state",children:[e.jsxs("h3",{children:["完整状态组件 (渲染: ",r,")"]}),e.jsx("p",{className:"warning",children:"⚠️ 此组件订阅了整个状态，任何状态变化都会导致重新渲染"}),e.jsxs("div",{className:"state-summary",children:[e.jsxs("p",{children:[e.jsx("strong",{children:"用户:"})," ",t.user.name]}),e.jsxs("p",{children:[e.jsx("strong",{children:"主题:"})," ",t.theme]}),e.jsxs("p",{children:[e.jsx("strong",{children:"文章数:"})," ",t.posts.length]}),e.jsxs("p",{children:[e.jsx("strong",{children:"加载中:"})," ",t.loading?"是":"否"]})]})]})}function O(){return e.jsx(E,{children:e.jsxs("div",{className:"selector-pattern-demo",children:[e.jsx("style",{children:`
