import{r as s,j as e}from"./index-DPG_OKoV.js";import{C as c}from"./ComponentTemplate-HXLvd6Xe.js";const i=s.memo(({data:r,onClick:t})=>{const n=s.useRef(0);return n.current++,e.jsxs("div",{className:"p-4 border border-green-300 rounded-lg bg-green-50",children:[e.jsx("h4",{className:"font-semibold text-green-700",children:"Memo 优化组件"}),e.jsxs("p",{className:"text-sm text-gray-600",children:["渲染次数: ",n.current]}),e.jsxs("p",{className:"text-sm",children:["数据: ",JSON.stringify(r)]}),e.jsx("button",{onClick:t,className:"mt-2 px-3 py-1 bg-green-500 text-white rounded hover:bg-green-600",children:"点击我"})]})}),u=({data:r,onClick:t})=>{const n=s.useRef(0);return n.current++,e.jsxs("div",{className:"p-4 border border-red-300 rounded-lg bg-red-50",children:[e.jsx("h4",{className:"font-semibold text-red-700",children:"普通组件"}),e.jsxs("p",{className:"text-sm text-gray-600",children:["渲染次数: ",n.current]}),e.jsxs("p",{className:"text-sm",children:["数据: ",JSON.stringify(r)]}),e.jsx("button",{onClick:t,className:"mt-2 px-3 py-1 bg-red-500 text-white rounded hover:bg-red-600",children:"点击我"})]})},x=()=>{const[r,t]=s.useState(0),[n,a]=s.useState(0),l=s.useCallback(()=>{console.log("按钮被点击")},[]),d=s.useMemo(()=>({value:r}),[r]),m={value:r};return e.jsxs("div",{className:"space-y-6",children:[e.jsxs("div",{className:"bg-blue-50 p-4 rounded-lg",children:[e.jsx("h3",{className:"text-lg font-semibold mb-4",children:"控制面板"}),e.jsxs("div",{className:"flex gap-4",children:[e.jsxs("button",{onClick:()=>t(o=>o+1),className:"px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600",children:["更新数据 (count: ",r,")"]}),e.jsxs("button",{onClick:()=>a(o=>o+1),className:"px-4 py-2 bg-gray-500 text-white rounded hover:bg-gray-600",children:["无关更新 (unrelated: ",n,")"]})]})]}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6",children:[e.jsxs("div",{children:[e.jsx("h4",{className:"text-md font-semibold mb-2",children:"普通组件（每次都重新渲染）"}),e.jsx(u,{data:m,onClick:l})]}),e.jsxs("div",{children:[e.jsx("h4",{className:"text-md font-semibold mb-2",children:"Memo 优化组件（props 不变时跳过渲染）"}),e.jsx(i,{data:d,onClick:l})]})]})]})},p=`import { useCallback, useMemo, useState } from "react";\r
\r
