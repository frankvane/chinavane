import{j as e,r as c,R as h}from"./index-DPG_OKoV.js";import{C as j}from"./ComponentTemplate-HXLvd6Xe.js";const v=`import React, { useState } from 'react';
...
}`,y=`import React, { createContext, useContext, useEffect, useState, useRef } from 'react';\r
...
}`,w={user:{id:1,name:"John Doe",email:"john@example.com",avatar:"/src/assets/avatar.jpg"},theme:"light",posts:[{id:1,title:"第一篇文章",content:"这是第一篇文章的内容",author:"John Doe"},{id:2,title:"第二篇文章",content:"这是第二篇文章的内容",author:"John Doe"}],loading:!1};function k(r,t){switch(t.type){case"UPDATE_USER":return{...r,user:{...r.user,...t.payload}};case"TOGGLE_THEME":return{...r,theme:r.theme==="light"?"dark":"light"};case"ADD_POST":return{...r,posts:[...r.posts,t.payload]};case"TOGGLE_LOADING":return{...r,loading:!r.loading};default:return r}}function C(r,t){if(r===t)return!0;if(r==null||t==null||typeof r!="object"||typeof t!="object")return!1;const n=Object.keys(r),s=Object.keys(t);if(n.length!==s.length)return!1;for(const o of n)if(!s.includes(o)||r[o]!==t[o])return!1;return!0}function N(){let r=w;const t=new Map;return{getState:()=>r,dispatch:i=>{const a=k(r,i);a!==r&&(r=a,t.forEach((l,d)=>{const p=d(r);l.forEach(({callback:x,lastValue:f},S)=>{C(p,f)||(l[S].lastValue=p,x())})}))},subscribe:(i,a)=>{const l=i(r);t.has(i)||t.set(i,[]);const d=t.get(i),p={callback:a,lastValue:l};return d.push(p),()=>{const x=d.indexOf(p);x>-1&&(d.splice(x,1),d.length===0&&t.delete(i))}}}}const P=N(),b=c.createContext(null);function T({children:r}){return e.jsx(b.Provider,{value:P,children:r})}function u(r){const t=c.useContext(b);if(!t)throw new Error("useSelector must be used within a StoreProvider");const[n,s]=c.useState(()=>r(t.getState())),o=c.useRef(r),i=c.useRef(n);return o.current=r,i.current=n,c.useEffect(()=>t.subscribe(o.current,()=>{const l=o.current(t.getState());s(l)}),[t]),n}function g(){const r=c.useContext(b);if(!r)throw new Error("useDispatch must be used within a StoreProvider");return r.dispatch}function m(r){const t=h.useRef(0);return t.current+=1,h.useEffect(()=>{console.log(`${r} 渲染次数: ${t.current}`)}),t.current}function E(){const r=u(o=>o.user),t=g(),n=m("UserProfile"),s=()=>{t({type:"UPDATE_USER",payload:{name:`用户 ${Date.now().toString().slice(-4)}`,email:`user${Date.now().toString().slice(-4)}@example.com`}})};return e.jsxs("div",{className:"component-card",children:[e.jsxs("h3",{children:["用户信息 (渲染: ",n,")"]}),e.jsxs("div",{className:"user-info",children:[e.jsx("img",{src:r.avatar,alt:"头像",className:"avatar"}),e.jsxs("div",{children:[e.jsxs("p",{children:[e.jsx("strong",{children:"姓名:"})," ",r.name]}),e.jsxs("p",{children:[e.jsx("strong",{children:"邮箱:"})," ",r.email]})]})]}),e.jsx("button",{onClick:s,className:"btn btn-primary",children:"更新用户信息"})]})}function R(){const r=u(o=>o.theme),t=g(),n=m("ThemeSettings"),s=()=>{t({type:"TOGGLE_THEME"})};return e.jsxs("div",{className:`component-card theme-${r}`,children:[e.jsxs("h3",{children:["主题设置 (渲染: ",n,")"]}),e.jsxs("p",{children:["当前主题: ",e.jsx("strong",{children:r==="light"?"浅色":"深色"})]}),e.jsx("button",{onClick:s,className:"btn btn-secondary",children:"切换主题"})]})}function D(){const r=u(a=>a.posts),t=g(),n=m("PostList"),[s,o]=c.useState(""),i=()=>{if(s.trim()){const a={id:Date.now(),title:s,content:`这是《${s}》的内容`,author:"当前用户"};t({type:"ADD_POST",payload:a}),o("")}};return e.jsxs("div",{className:"component-card",children:[e.jsxs("h3",{children:["文章列表 (渲染: ",n,")"]}),e.jsxs("div",{className:"post-input",children:[e.jsx("input",{type:"text",value:s,onChange:a=>o(a.target.value),placeholder:"输入文章标题",className:"input"}),e.jsx("button",{onClick:i,className:"btn btn-success",children:"添加文章"})]}),e.jsx("div",{className:"posts",children:r.map(a=>e.jsxs("div",{className:"post-item",children:[e.jsx("h4",{children:a.title}),e.jsx("p",{children:a.content}),e.jsxs("small",{children:["作者: ",a.author]})]},a.id))})]})}function A(){const r=u(o=>o.loading),t=g(),n=m("LoadingIndicator"),s=()=>{t({type:"TOGGLE_LOADING"})};return e.jsxs("div",{className:"component-card",children:[e.jsxs("h3",{children:["加载状态 (渲染: ",n,")"]}),e.jsx("div",{className:"loading-status",children:r?e.jsxs("div",{className:"loading-spinner",children:[e.jsx("div",{className:"spinner"}),e.jsx("span",{children:"加载中..."})]}):e.jsx("span",{className:"status-idle",children:"空闲状态"})}),e.jsx("button",{onClick:s,className:"btn btn-warning",children:"切换加载状态"})]})}function L(){const r=u(n=>n),t=m("FullStateComponent");return e.jsxs("div",{className:"component-card full-state",children:[e.jsxs("h3",{children:["完整状态组件 (渲染: ",t,")"]}),e.jsx("p",{className:"warning",children:"⚠️ 此组件订阅了整个状态，任何状态变化都会导致重新渲染"}),e.jsxs("div",{className:"state-summary",children:[e.jsxs("p",{children:[e.jsx("strong",{children:"用户:"})," ",r.user.name]}),e.jsxs("p",{children:[e.jsx("strong",{children:"主题:"})," ",r.theme]}),e.jsxs("p",{children:[e.jsx("strong",{children:"文章数:"})," ",r.posts.length]}),e.jsxs("p",{children:[e.jsx("strong",{children:"加载中:"})," ",r.loading?"是":"否"]})]})]})}function M(){return e.jsx(T,{children:e.jsxs("div",{className:"selector-pattern-demo",children:[e.jsx("style",{children:`
