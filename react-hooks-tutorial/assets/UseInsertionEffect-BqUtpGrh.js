import{r as s,j as e}from"./index-D5aG88J3.js";import{C}from"./ComponentTemplate-DZf1RTVD.js";const w=()=>{const[n,g]=s.useState(!1),[a,x]=s.useState([]),[d,r]=s.useState(0),l=(t,i)=>{const f={id:Date.now()+Math.random(),message:t,timestamp:new Date().toLocaleTimeString(),type:i};x(h=>[...h.slice(-4),f])};s.useInsertionEffect(()=>{const t=`
      .dynamic-demo-box {
