import{r as u,j as e}from"./index-D5aG88J3.js";import{C as b}from"./ComponentTemplate-DZf1RTVD.js";const v=`import React, { createContext, useContext } from 'react';
...
export const useAuthContext = (): AuthContextType => {
  ...
  return context;
};`,p={async login(s,t){await new Promise(r=>setTimeout(r,1e3));const i=[{id:"1",username:"admin",password:"admin123",email:"admin@example.com",role:"admin"},{id:"2",username:"user",password:"user123",email:"user@example.com",role:"user"},{id:"3",username:"guest",password:"guest123",email:"guest@example.com",role:"guest"}].find(r=>r.username===s&&r.password===t);if(i){const{password:r,...c}=i;return{success:!0,user:c}}else return{success:!1,error:"用户名或密码错误"}},async register(s){if(await new Promise(r=>setTimeout(r,1200)),s.username==="admin"||s.username==="user")return{success:!1,error:"用户名已存在"};const{password:t,...n}=s;return{success:!0,user:{...n,id:Date.now().toString()}}},async updateProfile(s,t){return await new Promise(n=>setTimeout(n,800)),{success:!0,user:{id:s,username:t.username||"updated_user",email:t.email||"updated@example.com",role:t.role||"user"}}},async getCurrentUser(){return await new Promise(t=>setTimeout(t,500)),localStorage.getItem("auth_token")?{success:!0,user:{id:"1",username:"demo_user",email:"demo@example.com",role:"user"}}:{success:!1}}},g={admin:["read","write","delete","manage_users","manage_system"],user:["read","write"],guest:["read"]},y=(s,t)=>{var n;return s&&((n=g[s])==null?void 0:n.includes(t))||!1};function w(){const[s,t]=u.useState({user:null,isAuthenticated:!1,isLoading:!0,error:null});u.useEffect(()=>{(async()=>{try{const a=await p.getCurrentUser();a.success&&a.user?t({user:a.user,isAuthenticated:!0,isLoading:!1,error:null}):t(o=>({...o,isLoading:!1}))}catch{t(o=>({...o,isLoading:!1,error:"初始化失败"}))}})()},[]);const n=u.useCallback(async(l,a)=>{t(o=>({...o,isLoading:!0,error:null}));try{const o=await p.login(l,a);return o.success&&o.user?(t({user:o.user,isAuthenticated:!0,isLoading:!1,error:null}),localStorage.setItem("auth_token","mock_token_"+o.user.id),!0):(t(h=>({...h,isLoading:!1,error:o.error||"登录失败"})),!1)}catch{return t(h=>({...h,isLoading:!1,error:"网络错误"})),!1}},[]),i=u.useCallback(()=>{t({user:null,isAuthenticated:!1,isLoading:!1,error:null}),localStorage.removeItem("auth_token")},[]),r=u.useCallback(async l=>{t(a=>({...a,isLoading:!0,error:null}));try{const a=await p.register(l);return a.success&&a.user?(t({user:a.user,isAuthenticated:!0,isLoading:!1,error:null}),localStorage.setItem("auth_token","mock_token_"+a.user.id),!0):(t(o=>({...o,isLoading:!1,error:a.error||"注册失败"})),!1)}catch{return t(o=>({...o,isLoading:!1,error:"网络错误"})),!1}},[]),c=u.useCallback(async l=>{if(!s.user)return!1;t(a=>({...a,isLoading:!0,error:null}));try{const a=await p.updateProfile(s.user.id,l);return a.success&&a.user?(t(o=>({...o,user:a.user,isLoading:!1})),!0):(t(o=>({...o,isLoading:!1,error:a.error||"更新失败"})),!1)}catch{return t(o=>({...o,isLoading:!1,error:"网络错误"})),!1}},[s.user]),d=u.useCallback(()=>{t(l=>({...l,error:null}))},[]),m=u.useCallback(l=>{var a;return y((a=s.user)==null?void 0:a.role,l)},[s.user]);return{...s,login:n,logout:i,register:r,updateProfile:c,clearError:d,hasPermission:m}}const f=u.createContext(null),N=({children:s})=>{const t=w();return e.jsx(f.Provider,{value:t,children:s})},x=()=>{const s=u.useContext(f);if(!s)throw new Error("useAuthContext must be used within an AuthProvider");return s},C=()=>{const[s,t]=u.useState(""),[n,i]=u.useState(""),r=x(),c=async d=>{d.preventDefault(),await r.login(s,n)};return e.jsxs("div",{className:"max-w-sm mx-auto p-4 bg-white rounded-lg border",children:[e.jsx("h3",{className:"text-lg font-semibold mb-4",children:"用户登录"}),r.error&&e.jsxs("div",{className:"mb-3 p-2 bg-red-100 border border-red-300 rounded text-red-700 text-sm",children:[r.error,e.jsx("button",{onClick:r.clearError,className:"ml-2 text-red-500 hover:text-red-700",children:"✕"})]}),e.jsxs("form",{onSubmit:c,className:"space-y-3",children:[e.jsx("div",{children:e.jsx("input",{type:"text",value:s,onChange:d=>t(d.target.value.trim()),placeholder:"用户名 (admin/user/guest)",className:"w-full px-3 py-2 border rounded text-sm",disabled:r.isLoading})}),e.jsx("div",{children:e.jsx("input",{type:"password",value:n,onChange:d=>i(d.target.value.trim()),placeholder:"密码 (如: admin123)",className:"w-full px-3 py-2 border rounded text-sm",disabled:r.isLoading})}),e.jsx("button",{type:"submit",disabled:r.isLoading||!s||!n,className:"w-full bg-blue-500 text-white py-2 rounded text-sm hover:bg-blue-600 disabled:opacity-50",children:r.isLoading?"登录中...":"登录"})]}),e.jsxs("div",{className:"mt-3 text-xs text-gray-500",children:[e.jsx("p",{children:"测试账号："}),e.jsx("p",{children:"admin/admin123 (管理员)"}),e.jsx("p",{children:"user/user123 (普通用户)"}),e.jsx("p",{children:"guest/guest123 (访客)"})]})]})},P=()=>{var d;const s=x(),[t,n]=u.useState(!1),[i,r]=u.useState({username:"",email:""});u.useEffect(()=>{s.user&&r({username:s.user.username,email:s.user.email})},[s.user]);const c=async()=>{await s.updateProfile(i)&&n(!1)};return s.user?e.jsxs("div",{className:"max-w-sm mx-auto p-4 bg-white rounded-lg border",children:[e.jsxs("div",{className:"flex justify-between items-center mb-4",children:[e.jsx("h3",{className:"text-lg font-semibold",children:"用户信息"}),e.jsx("button",{onClick:s.logout,className:"text-sm text-red-500 hover:text-red-700",children:"退出登录"})]}),s.error&&e.jsx("div",{className:"mb-3 p-2 bg-red-100 border border-red-300 rounded text-red-700 text-sm",children:s.error}),e.jsxs("div",{className:"space-y-3",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("span",{className:"text-sm font-medium",children:"ID:"}),e.jsx("span",{className:"text-sm text-gray-600",children:s.user.id})]}),e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("span",{className:"text-sm font-medium",children:"用户名:"}),t?e.jsx("input",{type:"text",value:i.username,onChange:m=>r(l=>({...l,username:m.target.value})),className:"text-sm border rounded px-2 py-1 w-24"}):e.jsx("span",{className:"text-sm text-gray-600",children:s.user.username})]}),e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("span",{className:"text-sm font-medium",children:"邮箱:"}),t?e.jsx("input",{type:"email",value:i.email,onChange:m=>r(l=>({...l,email:m.target.value})),className:"text-sm border rounded px-2 py-1 w-32"}):e.jsx("span",{className:"text-sm text-gray-600",children:s.user.email})]}),e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("span",{className:"text-sm font-medium",children:"角色:"}),e.jsx("span",{className:`text-sm px-2 py-1 rounded ${s.user.role==="admin"?"bg-red-100 text-red-700":s.user.role==="user"?"bg-blue-100 text-blue-700":"bg-gray-100 text-gray-700"}`,children:s.user.role})]}),e.jsxs("div",{className:"pt-2 border-t",children:[e.jsx("p",{className:"text-xs text-gray-500 mb-2",children:"权限:"}),e.jsx("div",{className:"flex flex-wrap gap-1",children:(d=g[s.user.role])==null?void 0:d.map(m=>e.jsx("span",{className:"text-xs bg-green-100 text-green-700 px-2 py-1 rounded",children:m},m))})]}),e.jsx("div",{className:"flex gap-2 pt-2",children:t?e.jsxs(e.Fragment,{children:[e.jsx("button",{onClick:c,disabled:s.isLoading,className:"flex-1 bg-green-500 text-white py-1 rounded text-sm hover:bg-green-600 disabled:opacity-50",children:s.isLoading?"更新中...":"保存"}),e.jsx("button",{onClick:()=>n(!1),className:"flex-1 bg-gray-500 text-white py-1 rounded text-sm hover:bg-gray-600",children:"取消"})]}):e.jsx("button",{onClick:()=>n(!0),className:"w-full bg-blue-500 text-white py-1 rounded text-sm hover:bg-blue-600",children:"编辑资料"})})]})]}):null},A=()=>{var n,i;const s=x(),t=["read","write","delete","manage_users","manage_system"];return e.jsxs("div",{className:"max-w-sm mx-auto p-4 bg-gray-50 rounded-lg",children:[e.jsx("h4",{className:"font-semibold mb-3",children:"权限检查"}),s.isAuthenticated?e.jsxs("div",{className:"space-y-2",children:[e.jsxs("p",{className:"text-sm text-gray-600 mb-2",children:["当前用户: ",(n=s.user)==null?void 0:n.username," (",(i=s.user)==null?void 0:i.role,")"]}),t.map(r=>e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("span",{className:"text-sm",children:r}),e.jsx("span",{className:`text-xs px-2 py-1 rounded ${s.hasPermission(r)?"bg-green-100 text-green-700":"bg-red-100 text-red-700"}`,children:s.hasPermission(r)?"✓ 允许":"✗ 拒绝"})]},r))]}):e.jsx("p",{className:"text-sm text-gray-500",children:"请先登录以查看权限"})]})},j=()=>e.jsx(N,{children:e.jsx(k,{})}),k=()=>{var t,n,i;const s=x();return s.isLoading?e.jsxs("div",{className:"text-center py-8",children:[e.jsx("div",{className:"inline-block animate-spin rounded-full h-8 w-8 border-b-2 border-blue-500"}),e.jsx("p",{className:"mt-2 text-gray-600",children:"初始化中..."})]}):e.jsx("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-4",children:s.isAuthenticated?e.jsxs(e.Fragment,{children:[e.jsx(P,{}),e.jsx(A,{}),e.jsxs("div",{className:"p-4 bg-green-50 rounded-lg",children:[e.jsx("h4",{className:"font-semibold text-green-800 mb-2",children:"认证状态"}),e.jsxs("div",{className:"space-y-1 text-sm",children:[e.jsx("div",{children:"✅ 已登录"}),e.jsxs("div",{children:["👤 用户: ",(t=s.user)==null?void 0:t.username]}),e.jsxs("div",{children:["🔑 角色: ",(n=s.user)==null?void 0:n.role]}),e.jsxs("div",{children:["📧 邮箱: ",(i=s.user)==null?void 0:i.email]})]})]})]}):e.jsxs(e.Fragment,{children:[e.jsx(C,{}),e.jsx("div",{className:"md:col-span-2 flex items-center justify-center",children:e.jsx("p",{className:"text-gray-500",children:"请登录以查看更多功能"})})]})})},S=`import React from 'react';\r
