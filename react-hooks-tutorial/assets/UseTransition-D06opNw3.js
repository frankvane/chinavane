import{r as c,j as e}from"./index-CKH9Ek1I.js";import{C as w}from"./ComponentTemplate-B8dTsNLj.js";const T=()=>{const[a,f]=c.useState(""),[t,y]=c.useState([]),[l,j]=c.useTransition(),[p,g]=c.useState([]),m=c.useMemo(()=>Array.from({length:1e4},(n,i)=>`项目 ${i+1} - ${Math.random().toString(36).substring(2)}`),[]),v=n=>{const i=new Date().toLocaleTimeString();g(x=>[...x.slice(-5),`${i}: ${n}`])},h=n=>{f(n),v(`开始搜索: "${n}"`),j(()=>{const i=m.filter(x=>x.toLowerCase().includes(n.toLowerCase()));y(i),v(`搜索完成，找到 ${i.length} 个结果`)})},u=()=>{f(""),y([]),v("清空搜索")},r=()=>{g([])};return e.jsxs("div",{className:"p-6 bg-white rounded-lg border border-gray-200",children:[e.jsxs("div",{className:"flex items-center justify-between mb-4",children:[e.jsx("h3",{className:"text-lg font-semibold text-gray-800",children:"搜索过滤演示"}),e.jsxs("div",{className:"space-x-2",children:[e.jsx("button",{onClick:u,className:"px-3 py-1 bg-red-500 text-white rounded text-sm hover:bg-red-600 transition-colors",children:"清空搜索"}),e.jsx("button",{onClick:r,className:"px-3 py-1 bg-gray-500 text-white rounded text-sm hover:bg-gray-600 transition-colors",children:"清空日志"})]})]}),e.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-2 gap-6",children:[e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{children:[e.jsxs("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:["搜索内容 (总共 ",m.length.toLocaleString()," 项):"]}),e.jsxs("div",{className:"relative",children:[e.jsx("input",{type:"text",value:a,onChange:n=>h(n.target.value),placeholder:"输入关键词搜索...",className:"w-full px-3 py-2 pr-10 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"}),l&&e.jsx("div",{className:"absolute right-3 top-1/2 transform -translate-y-1/2",children:e.jsx("div",{className:"animate-spin rounded-full h-4 w-4 border-b-2 border-blue-500"})})]})]}),e.jsxs("div",{className:"flex items-center space-x-4",children:[e.jsxs("div",{className:`flex items-center space-x-2 px-3 py-1 rounded-full text-sm ${l?"bg-yellow-100 text-yellow-800":"bg-green-100 text-green-800"}`,children:[e.jsx("div",{className:`w-2 h-2 rounded-full ${l?"bg-yellow-500 animate-pulse":"bg-green-500"}`}),e.jsx("span",{children:l?"搜索中...":"搜索完成"})]}),e.jsxs("span",{className:"text-sm text-gray-600",children:["找到 ",t.length.toLocaleString()," 个结果"]})]}),e.jsxs("div",{className:"border border-gray-200 rounded-lg",children:[e.jsx("div",{className:"bg-gray-50 px-3 py-2 border-b border-gray-200",children:e.jsx("h4",{className:"font-semibold text-gray-700",children:"搜索结果"})}),e.jsx("div",{className:"max-h-60 overflow-y-auto",children:a===""?e.jsx("div",{className:"p-4 text-center text-gray-500",children:"请输入关键词开始搜索"}):t.length===0&&!l?e.jsx("div",{className:"p-4 text-center text-gray-500",children:"没有找到匹配的结果"}):e.jsxs("div",{className:"divide-y divide-gray-100",children:[t.slice(0,50).map((n,i)=>e.jsx("div",{className:"px-3 py-2 text-sm text-gray-700 hover:bg-gray-50",children:n},i)),t.length>50&&e.jsxs("div",{className:"px-3 py-2 text-sm text-gray-500 text-center bg-gray-50",children:["还有 ",(t.length-50).toLocaleString()," ","个结果..."]})]})})]})]}),e.jsxs("div",{children:[e.jsx("h4",{className:"font-semibold text-gray-700 mb-3",children:"操作日志:"}),e.jsx("div",{className:"bg-gray-50 rounded-lg p-3 min-h-[300px]",children:p.length===0?e.jsx("p",{className:"text-gray-500 text-sm",children:"输入搜索内容查看日志"}):e.jsx("div",{className:"space-y-1 max-h-60 overflow-y-auto",children:p.map((n,i)=>e.jsx("div",{className:"text-sm font-mono text-gray-700",children:n},i))})}),e.jsxs("div",{className:"mt-4 p-3 bg-blue-50 rounded border border-blue-200",children:[e.jsx("h4",{className:"font-semibold text-blue-800 mb-2",children:"性能指标:"}),e.jsxs("div",{className:"text-sm text-blue-700 space-y-1",children:[e.jsxs("p",{children:[e.jsx("strong",{children:"数据量:"})," ",m.length.toLocaleString()," 项"]}),e.jsxs("p",{children:[e.jsx("strong",{children:"搜索状态:"})," ",l?"进行中":"空闲"]}),e.jsxs("p",{children:[e.jsx("strong",{children:"结果数量:"})," ",t.length.toLocaleString()," 项"]}),e.jsxs("p",{children:[e.jsx("strong",{children:"显示数量:"})," ",Math.min(t.length,50)," ","项"]})]})]})]})]}),e.jsx("div",{className:"mt-4 p-3 bg-green-50 rounded border border-green-200",children:e.jsx("p",{className:"text-sm text-green-800",children:"💡 useTransition 将搜索过滤标记为非紧急更新，保持输入框的响应性，避免界面卡顿。"})})]})},S=()=>{var u;const[a,f]=c.useState(0),[t,y]=c.useTransition(),[l,j]=c.useState([]),p=r=>{const n=new Date().toLocaleTimeString();j(i=>[...i.slice(-5),`${n}: ${r}`])},g=r=>Array.from({length:1e3},(i,x)=>e.jsxs("div",{className:"p-2 border-b border-gray-100 text-sm",children:["标签页 ",r+1," - 项目 ",x+1,":"," ",Math.random().toString(36).substring(2)]},x)),m=[{id:"home",title:"首页",content:e.jsxs("div",{className:"space-y-2",children:[e.jsx("h3",{className:"text-lg font-semibold text-gray-800",children:"欢迎来到首页"}),e.jsx("p",{className:"text-gray-600",children:"这是一个简单的标签页内容，渲染速度很快。"}),e.jsxs("div",{className:"grid grid-cols-2 gap-4 mt-4",children:[e.jsxs("div",{className:"p-4 bg-blue-50 rounded-lg",children:[e.jsx("h4",{className:"font-semibold text-blue-800",children:"快速访问"}),e.jsx("p",{className:"text-sm text-blue-600 mt-1",children:"这个标签页加载很快"})]}),e.jsxs("div",{className:"p-4 bg-green-50 rounded-lg",children:[e.jsx("h4",{className:"font-semibold text-green-800",children:"实时状态"}),e.jsx("p",{className:"text-sm text-green-600 mt-1",children:"界面响应迅速"})]})]})]})},{id:"products",title:"产品列表",content:e.jsxs("div",{children:[e.jsx("h3",{className:"text-lg font-semibold text-gray-800 mb-3",children:"产品列表 (1000 项)"}),e.jsx("div",{className:"max-h-60 overflow-y-auto border border-gray-200 rounded",children:g(1)})]})},{id:"analytics",title:"数据分析",content:e.jsxs("div",{children:[e.jsx("h3",{className:"text-lg font-semibold text-gray-800 mb-3",children:"数据分析 (1000 项)"}),e.jsx("div",{className:"max-h-60 overflow-y-auto border border-gray-200 rounded",children:g(2)})]})},{id:"settings",title:"设置",content:e.jsxs("div",{children:[e.jsx("h3",{className:"text-lg font-semibold text-gray-800 mb-3",children:"系统设置 (1000 项)"}),e.jsx("div",{className:"max-h-60 overflow-y-auto border border-gray-200 rounded",children:g(3)})]})}],v=r=>{p(`开始切换到: ${m[r].title}`),y(()=>{f(r),p(`切换完成: ${m[r].title}`)})},h=()=>{j([])};return e.jsxs("div",{className:"p-6 bg-white rounded-lg border border-gray-200",children:[e.jsxs("div",{className:"flex items-center justify-between mb-4",children:[e.jsx("h3",{className:"text-lg font-semibold text-gray-800",children:"标签页切换演示"}),e.jsx("button",{onClick:h,className:"px-3 py-1 bg-gray-500 text-white rounded text-sm hover:bg-gray-600 transition-colors",children:"清空日志"})]}),e.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-2 gap-6",children:[e.jsxs("div",{className:"space-y-4",children:[e.jsx("div",{className:"flex items-center space-x-2",children:e.jsxs("div",{className:`flex items-center space-x-2 px-3 py-1 rounded-full text-sm ${t?"bg-yellow-100 text-yellow-800":"bg-green-100 text-green-800"}`,children:[e.jsx("div",{className:`w-2 h-2 rounded-full ${t?"bg-yellow-500 animate-pulse":"bg-green-500"}`}),e.jsx("span",{children:t?"切换中...":"切换完成"})]})}),e.jsx("div",{className:"border-b border-gray-200",children:e.jsx("nav",{className:"flex space-x-1",children:m.map((r,n)=>e.jsxs("button",{onClick:()=>v(n),className:`px-4 py-2 text-sm font-medium rounded-t-lg transition-colors ${a===n?"bg-blue-500 text-white border-b-2 border-blue-500":"bg-gray-100 text-gray-700 hover:bg-gray-200"}`,children:[r.title,t&&a!==n&&e.jsx("span",{className:"ml-2 inline-block w-2 h-2 bg-yellow-400 rounded-full animate-pulse"})]},r.id))})}),e.jsx("div",{className:"min-h-[300px] p-4 bg-gray-50 rounded-lg",children:t?e.jsx("div",{className:"flex items-center justify-center h-40",children:e.jsxs("div",{className:"text-center",children:[e.jsx("div",{className:"animate-spin rounded-full h-8 w-8 border-b-2 border-blue-500 mx-auto mb-2"}),e.jsx("p",{className:"text-gray-600",children:"加载中..."})]})}):m[a].content})]}),e.jsxs("div",{children:[e.jsx("h4",{className:"font-semibold text-gray-700 mb-3",children:"操作日志:"}),e.jsx("div",{className:"bg-gray-50 rounded-lg p-3 min-h-[200px]",children:l.length===0?e.jsx("p",{className:"text-gray-500 text-sm",children:"点击标签页查看切换日志"}):e.jsx("div",{className:"space-y-1 max-h-40 overflow-y-auto",children:l.map((r,n)=>e.jsx("div",{className:"text-sm font-mono text-gray-700",children:r},n))})}),e.jsxs("div",{className:"mt-4 p-3 bg-purple-50 rounded border border-purple-200",children:[e.jsx("h4",{className:"font-semibold text-purple-800 mb-2",children:"切换状态:"}),e.jsxs("div",{className:"text-sm text-purple-700 space-y-1",children:[e.jsxs("p",{children:[e.jsx("strong",{children:"当前标签页:"})," ",(u=m[a])==null?void 0:u.title]}),e.jsxs("p",{children:[e.jsx("strong",{children:"切换状态:"})," ",t?"进行中":"完成"]}),e.jsxs("p",{children:[e.jsx("strong",{children:"标签页数量:"})," ",m.length]})]})]}),e.jsxs("div",{className:"mt-4 p-3 bg-orange-50 rounded border border-orange-200",children:[e.jsx("h4",{className:"font-semibold text-orange-800 mb-2",children:"性能提示:"}),e.jsxs("ul",{className:"text-sm text-orange-700 space-y-1",children:[e.jsx("li",{children:"• 复杂标签页使用 transition 避免卡顿"}),e.jsx("li",{children:"• 保持界面响应性"}),e.jsx("li",{children:"• 用户可以随时取消切换"})]})]})]})]}),e.jsx("div",{className:"mt-4 p-3 bg-yellow-50 rounded border border-yellow-200",children:e.jsx("p",{className:"text-sm text-yellow-800",children:"💡 标签页切换使用 useTransition，即使内容复杂也能保持界面响应，用户可以随时切换到其他标签页。"})})]})},L=()=>{const[a,f]=c.useState("name"),[t,y]=c.useState("asc"),[l,j]=c.useTransition(),[p,g]=c.useState([]),m=s=>{const o=new Date().toLocaleTimeString();g(N=>[...N.slice(-5),`${o}: ${s}`])},v=()=>{const s=["电子产品","服装","食品","图书","家居"],o=["产品A","产品B","产品C","产品D","产品E"];return Array.from({length:5e3},(N,d)=>({id:d+1,name:`${o[d%o.length]}${d+1}`,price:Math.floor(Math.random()*1e3)+10,category:s[d%s.length]}))},h=c.useMemo(()=>v(),[]),u=c.useMemo(()=>[...h].sort((o,N)=>{let d,b;switch(a){case"name":d=o.name,b=N.name;break;case"price":d=o.price,b=N.price;break;case"category":d=o.category,b=N.category;break;default:d=o.name,b=N.name}return typeof d=="string"&&typeof b=="string"?t==="asc"?d.localeCompare(b):b.localeCompare(d):t==="asc"?d-b:b-d}),[h,a,t]),r=s=>{m(`开始排序: ${s} (${t==="asc"?"升序":"降序"})`),j(()=>{a===s?y(o=>o==="asc"?"desc":"asc"):(f(s),y("asc")),m(`排序完成: ${s}`)})},n=()=>{g([])},i=s=>a!==s?"↕️":t==="asc"?"↑":"↓",x=u.slice(0,100);return e.jsxs("div",{className:"p-6 bg-white rounded-lg border border-gray-200",children:[e.jsxs("div",{className:"flex items-center justify-between mb-4",children:[e.jsx("h3",{className:"text-lg font-semibold text-gray-800",children:"列表排序演示"}),e.jsx("button",{onClick:n,className:"px-3 py-1 bg-gray-500 text-white rounded text-sm hover:bg-gray-600 transition-colors",children:"清空日志"})]}),e.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-3 gap-6",children:[e.jsxs("div",{className:"lg:col-span-2",children:[e.jsxs("div",{className:"flex items-center space-x-2 mb-4",children:[e.jsxs("div",{className:`flex items-center space-x-2 px-3 py-1 rounded-full text-sm ${l?"bg-yellow-100 text-yellow-800":"bg-green-100 text-green-800"}`,children:[e.jsx("div",{className:`w-2 h-2 rounded-full ${l?"bg-yellow-500 animate-pulse":"bg-green-500"}`}),e.jsx("span",{children:l?"排序中...":"排序完成"})]}),e.jsxs("span",{className:"text-sm text-gray-600",children:["共 ",h.length," 条数据"]})]}),e.jsxs("div",{className:"border border-gray-200 rounded-lg overflow-hidden",children:[e.jsxs("table",{className:"w-full",children:[e.jsx("thead",{className:"bg-gray-50",children:e.jsxs("tr",{children:[e.jsx("th",{className:"px-4 py-3 text-left",children:e.jsxs("button",{onClick:()=>r("name"),className:`flex items-center space-x-1 font-semibold text-sm hover:text-blue-600 transition-colors ${a==="name"?"text-blue-600":"text-gray-700"}`,children:[e.jsx("span",{children:"名称"}),e.jsx("span",{className:"text-xs",children:i("name")})]})}),e.jsx("th",{className:"px-4 py-3 text-left",children:e.jsxs("button",{onClick:()=>r("price"),className:`flex items-center space-x-1 font-semibold text-sm hover:text-blue-600 transition-colors ${a==="price"?"text-blue-600":"text-gray-700"}`,children:[e.jsx("span",{children:"价格"}),e.jsx("span",{className:"text-xs",children:i("price")})]})}),e.jsx("th",{className:"px-4 py-3 text-left",children:e.jsxs("button",{onClick:()=>r("category"),className:`flex items-center space-x-1 font-semibold text-sm hover:text-blue-600 transition-colors ${a==="category"?"text-blue-600":"text-gray-700"}`,children:[e.jsx("span",{children:"分类"}),e.jsx("span",{className:"text-xs",children:i("category")})]})})]})}),e.jsx("tbody",{children:x.map((s,o)=>e.jsxs("tr",{className:o%2===0?"bg-white":"bg-gray-50",children:[e.jsx("td",{className:"px-4 py-2 text-sm text-gray-900",children:s.name}),e.jsxs("td",{className:"px-4 py-2 text-sm text-gray-900",children:["¥",s.price]}),e.jsx("td",{className:"px-4 py-2 text-sm text-gray-900",children:s.category})]},s.id))})]}),u.length>100&&e.jsx("div",{className:"px-4 py-3 bg-gray-50 border-t border-gray-200 text-center",children:e.jsxs("p",{className:"text-sm text-gray-600",children:["显示前 100 条，还有 ",u.length-100," 条数据"]})})]})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{children:[e.jsx("h4",{className:"font-semibold text-gray-700 mb-3",children:"排序状态:"}),e.jsx("div",{className:`p-3 rounded-lg border ${l?"bg-yellow-50 border-yellow-200":"bg-green-50 border-green-200"}`,children:l?e.jsxs("div",{className:"flex items-center space-x-2",children:[e.jsx("div",{className:"animate-spin rounded-full h-4 w-4 border-b-2 border-yellow-500"}),e.jsx("span",{className:"text-sm text-yellow-800",children:"正在排序..."})]}):e.jsx("span",{className:"text-sm text-green-800",children:"排序完成"})})]}),e.jsxs("div",{children:[e.jsx("h4",{className:"font-semibold text-gray-700 mb-3",children:"操作日志:"}),e.jsx("div",{className:"bg-gray-50 rounded-lg p-3 min-h-[150px]",children:p.length===0?e.jsx("p",{className:"text-gray-500 text-sm",children:"点击表头进行排序"}):e.jsx("div",{className:"space-y-1 max-h-32 overflow-y-auto",children:p.map((s,o)=>e.jsx("div",{className:"text-sm font-mono text-gray-700",children:s},o))})})]}),e.jsxs("div",{className:"p-3 bg-blue-50 rounded border border-blue-200",children:[e.jsx("h4",{className:"font-semibold text-blue-800 mb-2",children:"排序信息:"}),e.jsxs("div",{className:"text-sm text-blue-700 space-y-1",children:[e.jsxs("p",{children:[e.jsx("strong",{children:"排序字段:"})," ",a==="name"?"名称":a==="price"?"价格":"分类"]}),e.jsxs("p",{children:[e.jsx("strong",{children:"排序方向:"})," ",t==="asc"?"升序":"降序"]}),e.jsxs("p",{children:[e.jsx("strong",{children:"数据总量:"})," ",h.length," 条"]}),e.jsxs("p",{children:[e.jsx("strong",{children:"显示数量:"})," ",x.length," 条"]})]})]}),e.jsxs("div",{className:"p-3 bg-orange-50 rounded border border-orange-200",children:[e.jsx("h4",{className:"font-semibold text-orange-800 mb-2",children:"性能优化:"}),e.jsxs("ul",{className:"text-sm text-orange-700 space-y-1",children:[e.jsx("li",{children:"• 大数据量排序不阻塞UI"}),e.jsx("li",{children:"• 保持界面响应性"}),e.jsx("li",{children:"• 可中断和恢复操作"})]})]})]})]}),e.jsx("div",{className:"mt-4 p-3 bg-yellow-50 rounded border border-yellow-200",children:e.jsx("p",{className:"text-sm text-yellow-800",children:"💡 大数据量排序使用 useTransition，避免长时间阻塞UI，用户可以随时进行其他操作。"})})]})},$=`import React, { useMemo, useState, useTransition } from "react";\r
\r
// 基础用法演示 - 搜索过滤\r
