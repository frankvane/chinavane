import{r as p,j as e}from"./index-CKH9Ek1I.js";import{C as D}from"./ComponentTemplate-B8dTsNLj.js";function S(r,u){const[b,y]=p.useState(()=>{try{const i=window.localStorage.getItem(r);return i?JSON.parse(i):u}catch(i){return console.warn(`Error reading localStorage key "${r}":`,i),u}}),h=p.useCallback(i=>{try{const d=i instanceof Function?i(b):i;y(d),window.localStorage.setItem(r,JSON.stringify(d))}catch(d){console.error(`Error setting localStorage key "${r}":`,d)}},[r,b]),x=p.useCallback(()=>{try{window.localStorage.removeItem(r),y(u)}catch(i){console.error(`Error removing localStorage key "${r}":`,i)}},[r,u]);return[b,h,x]}function E(r,u,b={}){const{serializer:y={serialize:JSON.stringify,deserialize:JSON.parse},syncAcrossTabs:h=!1,onError:x}=b,i=p.useRef(y),d=p.useRef(x);i.current=y,d.current=x;const[j,v]=p.useState(u),[N,m]=p.useState(!0),[L,f]=p.useState(null);p.useEffect(()=>{var a;try{const l=window.localStorage.getItem(r);l!==null&&v(i.current.deserialize(l)),f(null)}catch(l){const n=l instanceof Error?l:new Error("Unknown error");f(n),(a=d.current)==null||a.call(d,n)}finally{m(!1)}},[r]),p.useEffect(()=>{if(!h)return;const a=l=>{var n;if(l.key===r&&l.newValue!==null)try{v(i.current.deserialize(l.newValue)),f(null)}catch(g){const o=g instanceof Error?g:new Error("Unknown error");f(o),(n=d.current)==null||n.call(d,o)}};return window.addEventListener("storage",a),()=>window.removeEventListener("storage",a)},[r,h]);const w=p.useCallback(a=>{var l;try{const n=a instanceof Function?a(j):a;v(n),window.localStorage.setItem(r,i.current.serialize(n)),f(null)}catch(n){const g=n instanceof Error?n:new Error("Unknown error");f(g),(l=d.current)==null||l.call(d,g)}},[r,j]),s=p.useCallback(()=>{var a;try{window.localStorage.removeItem(r),v(u),f(null)}catch(l){const n=l instanceof Error?l:new Error("Unknown error");f(n),(a=d.current)==null||a.call(d,n)}},[r,u]);return{value:j,setValue:w,removeValue:s,isLoading:N,error:L}}const P=()=>{const[r,u]=p.useState([]),[b,y]=p.useState([]),h=o=>{const t=new Date().toLocaleTimeString();u(c=>[...c.slice(-4),`${t}: ${o.message}`])},{value:x,setValue:i,removeValue:d,isLoading:j,error:v}=E("app-settings",{autoSave:!0,syncInterval:30,maxHistory:10,compression:!1},{syncAcrossTabs:!0,onError:h}),{value:N,setValue:m,removeValue:L,isLoading:f,error:w}=E("user-profile",{username:"",email:"",avatar:"",lastLogin:null,loginCount:0},{serializer:{serialize:o=>JSON.stringify(o,(t,c)=>c instanceof Date?{__type:"Date",value:c.toISOString()}:c),deserialize:o=>JSON.parse(o,(t,c)=>c&&c.__type==="Date"?new Date(c.value):c)},syncAcrossTabs:!0,onError:h});p.useEffect(()=>{const o=t=>{if(t.key&&(t.key==="app-settings"||t.key==="user-profile")){const c=new Date().toLocaleTimeString();y(C=>[...C.slice(-4),`${c}: ${t.key} 已在其他标签页更新`])}};return window.addEventListener("storage",o),()=>window.removeEventListener("storage",o)},[]);const s=()=>{m(o=>({...o,lastLogin:new Date,loginCount:o.loginCount+1}))},a=()=>{m(o=>({...o,lastLogin:null}))},l=()=>{try{const o="x".repeat(10485760);localStorage.setItem("test-large",o)}catch(o){h(o)}},n=()=>{d(),L(),u([]),y([])},g=()=>{window.open(window.location.href,"_blank")};return j||f?e.jsx("div",{className:"p-6 bg-white rounded-lg border border-gray-200",children:e.jsxs("div",{className:"flex items-center justify-center h-32",children:[e.jsx("div",{className:"animate-spin rounded-full h-8 w-8 border-b-2 border-blue-500"}),e.jsx("span",{className:"ml-2 text-gray-600",children:"加载存储数据中..."})]})}):e.jsxs("div",{className:"p-6 bg-white rounded-lg border border-gray-200",children:[e.jsxs("div",{className:"flex items-center justify-between mb-4",children:[e.jsx("h3",{className:"text-lg font-semibold text-gray-800",children:"高级本地存储演示"}),e.jsxs("div",{className:"space-x-2",children:[e.jsx("button",{onClick:g,className:"px-3 py-1 bg-green-500 text-white rounded text-sm hover:bg-green-600 transition-colors",children:"打开新标签页"}),e.jsx("button",{onClick:l,className:"px-3 py-1 bg-orange-500 text-white rounded text-sm hover:bg-orange-600 transition-colors",children:"模拟错误"}),e.jsx("button",{onClick:n,className:"px-3 py-1 bg-red-500 text-white rounded text-sm hover:bg-red-600 transition-colors",children:"清空数据"})]})]}),e.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-2 gap-6",children:[e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{className:"p-4 bg-blue-50 rounded-lg border border-blue-200",children:[e.jsx("h4",{className:"font-semibold text-blue-800 mb-3",children:"应用设置"}),v&&e.jsxs("div",{className:"mb-3 p-2 bg-red-100 border border-red-300 rounded text-red-700 text-sm",children:["错误: ",v.message]}),e.jsxs("div",{className:"space-y-3",children:[e.jsxs("label",{className:"flex items-center space-x-2",children:[e.jsx("input",{type:"checkbox",checked:x.autoSave,onChange:o=>i(t=>({...t,autoSave:o.target.checked})),className:"text-blue-500 focus:ring-blue-500"}),e.jsx("span",{className:"text-sm text-blue-700",children:"自动保存"})]}),e.jsxs("div",{children:[e.jsxs("label",{className:"block text-sm font-medium text-blue-700 mb-1",children:["同步间隔: ",x.syncInterval,"秒"]}),e.jsx("input",{type:"range",min:"10",max:"300",step:"10",value:x.syncInterval,onChange:o=>i(t=>({...t,syncInterval:Number(o.target.value)})),className:"w-full"})]}),e.jsxs("div",{children:[e.jsxs("label",{className:"block text-sm font-medium text-blue-700 mb-1",children:["最大历史记录: ",x.maxHistory]}),e.jsx("input",{type:"range",min:"5",max:"50",step:"5",value:x.maxHistory,onChange:o=>i(t=>({...t,maxHistory:Number(o.target.value)})),className:"w-full"})]}),e.jsxs("label",{className:"flex items-center space-x-2",children:[e.jsx("input",{type:"checkbox",checked:x.compression,onChange:o=>i(t=>({...t,compression:o.target.checked})),className:"text-blue-500 focus:ring-blue-500"}),e.jsx("span",{className:"text-sm text-blue-700",children:"启用压缩"})]})]})]}),e.jsxs("div",{className:"p-4 bg-green-50 rounded-lg border border-green-200",children:[e.jsx("h4",{className:"font-semibold text-green-800 mb-3",children:"用户资料"}),w&&e.jsxs("div",{className:"mb-3 p-2 bg-red-100 border border-red-300 rounded text-red-700 text-sm",children:["错误: ",w.message]}),e.jsxs("div",{className:"space-y-3",children:[e.jsxs("div",{children:[e.jsx("label",{className:"block text-sm font-medium text-green-700 mb-1",children:"用户名:"}),e.jsx("input",{type:"text",value:N.username,onChange:o=>m(t=>({...t,username:o.target.value})),placeholder:"请输入用户名",className:"w-full px-3 py-2 border border-green-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"})]}),e.jsxs("div",{children:[e.jsx("label",{className:"block text-sm font-medium text-green-700 mb-1",children:"邮箱:"}),e.jsx("input",{type:"email",value:N.email,onChange:o=>m(t=>({...t,email:o.target.value})),placeholder:"请输入邮箱",className:"w-full px-3 py-2 border border-green-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"})]}),e.jsxs("div",{className:"flex space-x-2",children:[e.jsx("button",{onClick:s,className:"flex-1 px-3 py-2 bg-green-500 text-white rounded hover:bg-green-600 transition-colors",children:"模拟登录"}),e.jsx("button",{onClick:a,className:"flex-1 px-3 py-2 bg-gray-500 text-white rounded hover:bg-gray-600 transition-colors",children:"模拟登出"})]}),e.jsxs("div",{className:"p-2 bg-green-100 rounded text-sm",children:[e.jsxs("p",{className:"text-green-800",children:[e.jsx("strong",{children:"登录次数:"})," ",N.loginCount]}),e.jsxs("p",{className:"text-green-800",children:[e.jsx("strong",{children:"最后登录:"})," ",N.lastLogin?N.lastLogin.toLocaleString():"从未登录"]})]})]})]})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{children:[e.jsx("h4",{className:"font-semibold text-gray-700 mb-3",children:"存储状态:"}),e.jsx("div",{className:"bg-gray-50 rounded-lg p-3",children:e.jsxs("div",{className:"grid grid-cols-2 gap-4 text-sm",children:[e.jsxs("div",{className:"p-2 bg-blue-100 rounded",children:[e.jsx("p",{className:"font-medium text-blue-800",children:"设置状态:"}),e.jsx("p",{className:`text-sm ${v?"text-red-600":"text-green-600"}`,children:v?"错误":"正常"})]}),e.jsxs("div",{className:"p-2 bg-green-100 rounded",children:[e.jsx("p",{className:"font-medium text-green-800",children:"资料状态:"}),e.jsx("p",{className:`text-sm ${w?"text-red-600":"text-green-600"}`,children:w?"错误":"正常"})]})]})})]}),e.jsxs("div",{children:[e.jsx("h4",{className:"font-semibold text-gray-700 mb-3",children:"跨标签页同步日志:"}),e.jsx("div",{className:"bg-purple-50 rounded-lg p-3 h-24 overflow-y-auto",children:b.length===0?e.jsx("p",{className:"text-purple-500 text-sm",children:"打开新标签页测试同步"}):e.jsx("div",{className:"space-y-1",children:b.map((o,t)=>e.jsx("div",{className:"text-sm font-mono text-purple-700",children:o},t))})})]}),e.jsxs("div",{children:[e.jsx("h4",{className:"font-semibold text-gray-700 mb-3",children:"错误日志:"}),e.jsx("div",{className:"bg-red-50 rounded-lg p-3 h-24 overflow-y-auto",children:r.length===0?e.jsx("p",{className:"text-red-500 text-sm",children:"暂无错误"}):e.jsx("div",{className:"space-y-1",children:r.map((o,t)=>e.jsx("div",{className:"text-sm font-mono text-red-700",children:o},t))})})]}),e.jsxs("div",{className:"p-3 bg-cyan-50 rounded border border-cyan-200",children:[e.jsx("h4",{className:"font-semibold text-cyan-800 mb-2",children:"高级特性:"}),e.jsxs("ul",{className:"text-sm text-cyan-700 space-y-1",children:[e.jsx("li",{children:"• 自定义序列化器支持复杂数据类型"}),e.jsx("li",{children:"• 跨标签页实时同步"}),e.jsx("li",{children:"• 错误处理和状态管理"}),e.jsx("li",{children:"• 加载状态指示"})]})]}),e.jsxs("div",{className:"p-3 bg-teal-50 rounded border border-teal-200",children:[e.jsx("h4",{className:"font-semibold text-teal-800 mb-2",children:"测试说明:"}),e.jsxs("ul",{className:"text-sm text-teal-700 space-y-1",children:[e.jsx("li",{children:"• 修改设置后在新标签页查看同步效果"}),e.jsx("li",{children:'• 点击"模拟错误"测试错误处理'}),e.jsx("li",{children:"• 观察Date对象的序列化和反序列化"}),e.jsx("li",{children:"• 查看加载状态和错误状态的处理"})]})]})]})]}),e.jsx("div",{className:"mt-4 p-3 bg-emerald-50 rounded border border-emerald-200",children:e.jsx("p",{className:"text-sm text-emerald-800",children:"💡 高级 useLocalStorage 提供了完整的错误处理、跨标签页同步、自定义序列化等企业级功能，适用于复杂的数据持久化需求。"})})]})},I=`import React, { useState, useEffect } from 'react';
