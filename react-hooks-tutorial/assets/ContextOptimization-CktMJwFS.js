import{r as o,s as R,j as e}from"./index-CKH9Ek1I.js";import{C as H}from"./ComponentTemplate-B8dTsNLj.js";const h={user:{id:1,name:"John Doe",email:"john@example.com"},theme:"light",notifications:{count:5,enabled:!0}},f=Symbol(),W=Symbol(),J=typeof window>"u"||/ServerSideRendering/.test(window.navigator&&window.navigator.userAgent),z=J?o.useEffect:o.useLayoutEffect,$=R.unstable_runWithPriority?t=>{try{R.unstable_runWithPriority(R.unstable_NormalPriority,t)}catch(r){if(r.message==="Not implemented.")t();else throw r}}:t=>t(),G=t=>({value:n,children:s})=>{const u=o.useRef(n),d=o.useRef(0),[l,m]=o.useState(null);l&&(l(n),m(null));const c=o.useRef();if(!c.current){const i=new Set,a=(N,A)=>{d.current+=1;const S={n:d.current};A!=null&&A.suspense&&(S.n*=-1,S.p=new Promise(k=>{m(()=>U=>{S.v=U,delete S.p,k(U)})})),i.forEach(k=>k(S)),N()};c.current={[f]:{v:u,n:d,l:i,u:a}}}return z(()=>{u.current=n,d.current+=1,$(()=>{c.current[f].l.forEach(i=>{i({n:d.current,v:n})})})},[n]),o.createElement(t,{value:c.current},s)};function y(t){const r=o.createContext({[f]:{v:{current:t},n:{current:-1},l:new Set,u:n=>n()}});return r[W]=r.Provider,r.Provider=G(r.Provider),delete r.Consumer,r}function p(t,r){const n=o.useContext(t)[f],{v:{current:s},n:{current:u},l:d}=n,l=r(s),[m,c]=o.useReducer((i,a)=>{if(!a)return[s,l];if("p"in a)throw a.p;if(a.n===u)return Object.is(i[1],l)?i:[s,l];try{if("v"in a){if(Object.is(i[0],a.v))return i;const N=r(a.v);return Object.is(i[1],N)?i:[a.v,N]}}catch{}return[...i]},[s,l]);return Object.is(m[1],l)||c(),z(()=>(d.add(c),()=>{d.delete(c)}),[d]),m[1]}const v=y(null);let b={provider:0,consumer:0};const X=({children:t})=>{const[r,n]=o.useState(h),c={state:r,actions:{updateUser:i=>{n(a=>({...a,user:{...a.user,...i}}))},updateTheme:i=>{n(a=>({...a,theme:i}))},updateNotifications:i=>{n(a=>({...a,notifications:{...a.notifications,...i}}))},resetState:()=>{n(h)}}};return b.provider++,e.jsx(v.Provider,{value:c,children:t})},Z=({children:t})=>{const[r,n]=o.useState(h),s=o.useCallback(i=>{n(a=>({...a,user:{...a.user,...i}}))},[]),u=o.useCallback(i=>{n(a=>({...a,theme:i}))},[]),d=o.useCallback(i=>{n(a=>({...a,notifications:{...a.notifications,...i}}))},[]),l=o.useCallback(()=>{n(h)},[]),m=o.useMemo(()=>({updateUser:s,updateTheme:u,updateNotifications:d,resetState:l}),[s,u,d,l]),c=o.useMemo(()=>({state:r,actions:m}),[r,m]);return b.provider++,e.jsx(v.Provider,{value:c,children:t})},Q=()=>{const t=p(v,n=>n==null?void 0:n.state),r=p(v,n=>n==null?void 0:n.actions);if(!t||!r)throw new Error("BasicConsumerComponent must be used within BasicAppProvider");return b.consumer++,e.jsxs("div",{className:"p-4 border rounded-lg bg-red-50 border-red-200",children:[e.jsxs("h4",{className:"font-semibold text-red-800 mb-3",children:["未优化版本 (渲染次数: ",b.consumer,")"]}),e.jsxs("div",{className:"space-y-2 text-sm",children:[e.jsxs("div",{children:[e.jsx("strong",{children:"用户:"})," ",t.user.name," (",t.user.email,")"]}),e.jsxs("div",{children:[e.jsx("strong",{children:"主题:"})," ",t.theme]}),e.jsxs("div",{children:[e.jsx("strong",{children:"通知:"})," ",t.notifications.count," 条 (",t.notifications.enabled?"开启":"关闭",")"]})]}),e.jsxs("div",{className:"mt-3 space-x-2",children:[e.jsx("button",{onClick:()=>r.updateUser({name:"张三"}),className:"px-2 py-1 bg-red-500 text-white rounded text-xs hover:bg-red-600",children:"更新用户"}),e.jsx("button",{onClick:()=>r.updateTheme(t.theme==="light"?"dark":"light"),className:"px-2 py-1 bg-red-500 text-white rounded text-xs hover:bg-red-600",children:"切换主题"}),e.jsx("button",{onClick:()=>r.updateNotifications({count:t.notifications.count+1}),className:"px-2 py-1 bg-red-500 text-white rounded text-xs hover:bg-red-600",children:"增加通知"})]})]})},K=o.memo(()=>{const t=p(v,n=>n==null?void 0:n.state),r=p(v,n=>n==null?void 0:n.actions);if(!t||!r)throw new Error("OptimizedConsumerComponent must be used within OptimizedAppProvider");return b.consumer++,e.jsxs("div",{className:"p-4 border rounded-lg bg-green-50 border-green-200",children:[e.jsxs("h4",{className:"font-semibold text-green-800 mb-3",children:["优化版本 (渲染次数: ",b.consumer,")"]}),e.jsxs("div",{className:"space-y-2 text-sm",children:[e.jsxs("div",{children:[e.jsx("strong",{children:"用户:"})," ",t.user.name," (",t.user.email,")"]}),e.jsxs("div",{children:[e.jsx("strong",{children:"主题:"})," ",t.theme]}),e.jsxs("div",{children:[e.jsx("strong",{children:"通知:"})," ",t.notifications.count," 条 (",t.notifications.enabled?"开启":"关闭",")"]})]}),e.jsxs("div",{className:"mt-3 space-x-2",children:[e.jsx("button",{onClick:()=>r.updateUser({name:"李四"}),className:"px-2 py-1 bg-green-500 text-white rounded text-xs hover:bg-green-600",children:"更新用户"}),e.jsx("button",{onClick:()=>r.updateTheme(t.theme==="light"?"dark":"light"),className:"px-2 py-1 bg-green-500 text-white rounded text-xs hover:bg-green-600",children:"切换主题"}),e.jsx("button",{onClick:()=>r.updateNotifications({count:t.notifications.count+1}),className:"px-2 py-1 bg-green-500 text-white rounded text-xs hover:bg-green-600",children:"增加通知"})]})]})});K.displayName="OptimizedConsumerComponent";const Y=Q,ee=K,te=()=>{b={provider:0,consumer:0}},g=y(null),T=y(null);let C={provider:0,consumer:0,stateConsumer:0,actionsConsumer:0};const ne=({children:t})=>{const[r,n]=o.useState(h),s=o.useCallback(c=>{n(i=>({...i,user:{...i.user,...c}}))},[]),u=o.useCallback(c=>{n(i=>({...i,theme:c}))},[]),d=o.useCallback(c=>{n(i=>({...i,notifications:{...i.notifications,...c}}))},[]),l=o.useCallback(()=>{n(h)},[]),m=o.useMemo(()=>({updateUser:s,updateTheme:u,updateNotifications:d,resetState:l}),[s,u,d,l]);return C.provider++,e.jsx(g.Provider,{value:r,children:e.jsx(T.Provider,{value:m,children:t})})},D=o.memo(()=>{const t=p(g,s=>s==null?void 0:s.user),r=p(g,s=>s==null?void 0:s.theme),n=p(g,s=>s==null?void 0:s.notifications);if(!t||!r||!n)throw new Error("StateOnlyConsumerComponent must be used within SeparatedAppProvider");return C.stateConsumer=(C.stateConsumer||0)+1,e.jsxs("div",{className:"p-4 border rounded-lg bg-blue-50 border-blue-200",children:[e.jsxs("h4",{className:"font-semibold text-blue-800 mb-3",children:["只读状态组件 (渲染次数: ",C.stateConsumer,")"]}),e.jsxs("div",{className:"space-y-2 text-sm",children:[e.jsxs("div",{children:[e.jsx("strong",{children:"用户:"})," ",t.name," (",t.email,")"]}),e.jsxs("div",{children:[e.jsx("strong",{children:"主题:"})," ",r]}),e.jsxs("div",{children:[e.jsx("strong",{children:"通知:"})," ",n.count," 条 (",n.enabled?"开启":"关闭",")"]})]}),e.jsx("p",{className:"text-xs text-blue-600 mt-2",children:"💡 此组件只消费状态，不会因操作函数变化而重新渲染"})]})});D.displayName="StateOnlyConsumerComponent";const V=o.memo(()=>{const t=p(T,r=>r);if(!t)throw new Error("ActionsOnlyConsumerComponent must be used within SeparatedAppProvider");return C.actionsConsumer=(C.actionsConsumer||0)+1,e.jsxs("div",{className:"p-4 border rounded-lg bg-purple-50 border-purple-200",children:[e.jsxs("h4",{className:"font-semibold text-purple-800 mb-3",children:["操作组件 (渲染次数: ",C.actionsConsumer,")"]}),e.jsxs("div",{className:"space-x-2",children:[e.jsx("button",{onClick:()=>t.updateUser({name:"王五"}),className:"px-2 py-1 bg-purple-500 text-white rounded text-xs hover:bg-purple-600",children:"更新用户"}),e.jsx("button",{onClick:()=>t.updateTheme("dark"),className:"px-2 py-1 bg-purple-500 text-white rounded text-xs hover:bg-purple-600",children:"切换主题"}),e.jsx("button",{onClick:()=>t.updateNotifications({count:10}),className:"px-2 py-1 bg-purple-500 text-white rounded text-xs hover:bg-purple-600",children:"设置通知"})]}),e.jsx("p",{className:"text-xs text-purple-600 mt-2",children:"💡 此组件只消费操作，很少重新渲染，性能更好"})]})});V.displayName="ActionsOnlyConsumerComponent";const F=o.memo(()=>{const t=p(g,s=>s==null?void 0:s.user),r=p(g,s=>s==null?void 0:s.theme),n=p(T,s=>s);if(!t||!r||!n)throw new Error("MixedConsumerComponent must be used within SeparatedAppProvider");return C.consumer++,e.jsxs("div",{className:"p-4 border rounded-lg bg-gray-50 border-gray-200",children:[e.jsxs("h4",{className:"font-semibold text-gray-800 mb-3",children:["混合组件 (渲染次数: ",C.consumer,")"]}),e.jsxs("div",{className:"space-y-2 text-sm mb-3",children:[e.jsxs("div",{children:[e.jsx("strong",{children:"用户:"})," ",t.name]}),e.jsxs("div",{children:[e.jsx("strong",{children:"主题:"})," ",r]})]}),e.jsxs("div",{className:"space-x-2",children:[e.jsx("button",{onClick:()=>n.updateUser({name:"赵六"}),className:"px-2 py-1 bg-gray-500 text-white rounded text-xs hover:bg-gray-600",children:"更新用户"}),e.jsx("button",{onClick:()=>n.updateTheme(r==="light"?"dark":"light"),className:"px-2 py-1 bg-gray-500 text-white rounded text-xs hover:bg-gray-600",children:"切换主题"})]}),e.jsx("p",{className:"text-xs text-gray-600 mt-2",children:"💡 此组件同时消费状态和操作，会在状态变化时重新渲染"})]})});F.displayName="MixedConsumerComponent";const re=D,se=V,oe=F,ie=()=>{C={provider:0,consumer:0,stateConsumer:0,actionsConsumer:0}},O=y(null);let x={provider:0,consumer:0,userConsumer:0,themeConsumer:0,notificationConsumer:0};const ae=({children:t})=>{const[r,n]=o.useState(h),s=o.useCallback(i=>{n(a=>({...a,user:{...a.user,...i}}))},[]),u=o.useCallback(i=>{n(a=>({...a,theme:i}))},[]),d=o.useCallback(i=>{n(a=>({...a,notifications:{...a.notifications,...i}}))},[]),l=o.useCallback(()=>{n(h)},[]),m=o.useMemo(()=>({updateUser:s,updateTheme:u,updateNotifications:d,resetState:l}),[s,u,d,l]),c=o.useMemo(()=>({state:r,actions:m}),[r,m]);return x.provider++,e.jsx(O.Provider,{value:c,children:t})},j=t=>p(O,r=>{if(!r)throw new Error("useSelector must be used within SelectorAppProvider");return t(r)}),w=()=>p(O,t=>{if(!t)throw new Error("useActions must be used within SelectorAppProvider");return t.actions}),q=o.memo(()=>{const t=j(n=>n.state.user),r=w();return x.userConsumer=(x.userConsumer||0)+1,e.jsxs("div",{className:"p-4 border rounded-lg bg-indigo-50 border-indigo-200",children:[e.jsxs("h4",{className:"font-semibold text-indigo-800 mb-3",children:["用户选择器组件 (渲染次数: ",x.userConsumer,")"]}),e.jsxs("div",{className:"space-y-2 text-sm mb-3",children:[e.jsxs("div",{children:[e.jsx("strong",{children:"ID:"})," ",t.id]}),e.jsxs("div",{children:[e.jsx("strong",{children:"姓名:"})," ",t.name]}),e.jsxs("div",{children:[e.jsx("strong",{children:"邮箱:"})," ",t.email]})]}),e.jsxs("div",{className:"space-x-2",children:[e.jsx("button",{onClick:()=>r.updateUser({name:"选择器用户"}),className:"px-2 py-1 bg-indigo-500 text-white rounded text-xs hover:bg-indigo-600",children:"更新用户"}),e.jsx("button",{onClick:()=>r.updateUser({email:"selector@example.com"}),className:"px-2 py-1 bg-indigo-500 text-white rounded text-xs hover:bg-indigo-600",children:"更新邮箱"})]}),e.jsx("p",{className:"text-xs text-indigo-600 mt-2",children:"💡 只在用户信息变化时重新渲染"})]})});q.displayName="UserSelectorConsumerComponent";const I=o.memo(()=>{const t=j(n=>n.state.theme),r=w();return x.themeConsumer=(x.themeConsumer||0)+1,e.jsxs("div",{className:"p-4 border rounded-lg bg-yellow-50 border-yellow-200",children:[e.jsxs("h4",{className:"font-semibold text-yellow-800 mb-3",children:["主题选择器组件 (渲染次数: ",x.themeConsumer,")"]}),e.jsxs("div",{className:"space-y-2 text-sm mb-3",children:[e.jsxs("div",{children:[e.jsx("strong",{children:"当前主题:"})," ",t]}),e.jsx("div",{className:`w-4 h-4 rounded ${t==="light"?"bg-yellow-300":"bg-gray-800"}`})]}),e.jsxs("div",{className:"space-x-2",children:[e.jsx("button",{onClick:()=>r.updateTheme("light"),className:"px-2 py-1 bg-yellow-500 text-white rounded text-xs hover:bg-yellow-600",children:"浅色主题"}),e.jsx("button",{onClick:()=>r.updateTheme("dark"),className:"px-2 py-1 bg-yellow-500 text-white rounded text-xs hover:bg-yellow-600",children:"深色主题"})]}),e.jsx("p",{className:"text-xs text-yellow-600 mt-2",children:"💡 只在主题变化时重新渲染"})]})});I.displayName="ThemeSelectorConsumerComponent";const _=o.memo(()=>{const t=j(n=>n.state.notifications),r=w();return x.notificationConsumer=(x.notificationConsumer||0)+1,e.jsxs("div",{className:"p-4 border rounded-lg bg-green-50 border-green-200",children:[e.jsxs("h4",{className:"font-semibold text-green-800 mb-3",children:["通知选择器组件 (渲染次数: ",x.notificationConsumer,")"]}),e.jsxs("div",{className:"space-y-2 text-sm mb-3",children:[e.jsxs("div",{children:[e.jsx("strong",{children:"通知数量:"})," ",t.count]}),e.jsxs("div",{children:[e.jsx("strong",{children:"通知状态:"})," ",t.enabled?"开启":"关闭"]})]}),e.jsxs("div",{className:"space-x-2",children:[e.jsx("button",{onClick:()=>r.updateNotifications({count:t.count+1}),className:"px-2 py-1 bg-green-500 text-white rounded text-xs hover:bg-green-600",children:"增加通知"}),e.jsx("button",{onClick:()=>r.updateNotifications({enabled:!t.enabled}),className:"px-2 py-1 bg-green-500 text-white rounded text-xs hover:bg-green-600",children:"切换状态"}),e.jsx("button",{onClick:()=>r.updateNotifications({count:0}),className:"px-2 py-1 bg-green-500 text-white rounded text-xs hover:bg-green-600",children:"清空通知"})]}),e.jsx("p",{className:"text-xs text-green-600 mt-2",children:"💡 只在通知信息变化时重新渲染"})]})});_.displayName="NotificationSelectorConsumerComponent";const L=o.memo(()=>{const t=j(n=>({userName:n.state.user.name,theme:n.state.theme})),r=w();return x.consumer++,e.jsxs("div",{className:"p-4 border rounded-lg bg-pink-50 border-pink-200",children:[e.jsxs("h4",{className:"font-semibold text-pink-800 mb-3",children:["复合选择器组件 (渲染次数: ",x.consumer,")"]}),e.jsxs("div",{className:"space-y-2 text-sm mb-3",children:[e.jsxs("div",{children:[e.jsx("strong",{children:"用户:"})," ",t.userName]}),e.jsxs("div",{children:[e.jsx("strong",{children:"主题:"})," ",t.theme]})]}),e.jsxs("div",{className:"space-x-2",children:[e.jsx("button",{onClick:()=>r.updateUser({name:"复合用户"}),className:"px-2 py-1 bg-pink-500 text-white rounded text-xs hover:bg-pink-600",children:"更新用户"}),e.jsx("button",{onClick:()=>r.updateTheme(t.theme==="light"?"dark":"light"),className:"px-2 py-1 bg-pink-500 text-white rounded text-xs hover:bg-pink-600",children:"切换主题"})]}),e.jsx("p",{className:"text-xs text-pink-600 mt-2",children:"💡 只在用户名或主题变化时重新渲染"})]})});L.displayName="CompositeConsumerComponent";const ce=q,de=I,le=_,ue=L,me=()=>{x={provider:0,consumer:0,userConsumer:0,themeConsumer:0,notificationConsumer:0}},pe=()=>{const[t,r]=o.useState(0),n=()=>{te(),r(s=>s+1)};return e.jsxs("div",{className:"space-y-6",children:[e.jsxs("div",{className:"flex justify-between items-center",children:[e.jsx("h3",{className:"text-lg font-semibold text-gray-800",children:"Context 基础优化对比"}),e.jsx("button",{onClick:n,className:"px-3 py-1 bg-gray-500 text-white rounded text-sm hover:bg-gray-600",children:"重置计数"})]}),e.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-2 gap-6",children:[e.jsx(X,{children:e.jsx(Y,{})}),e.jsx(Z,{children:e.jsx(ee,{})})]},t),e.jsxs("div",{className:"bg-blue-50 p-4 rounded-lg border border-blue-200",children:[e.jsx("h4",{className:"font-semibold text-blue-800 mb-2",children:"🔍 观察要点"}),e.jsxs("ul",{className:"text-sm text-blue-700 space-y-1",children:[e.jsxs("li",{children:["• ",e.jsx("strong",{children:"点击任一按钮时"}),"：左侧组件的渲染次数会增加"]}),e.jsxs("li",{children:["• ",e.jsx("strong",{children:"右侧组件使用了优化"}),"：渲染次数增加较少"]}),e.jsxs("li",{children:["• ",e.jsx("strong",{children:"这展示了 Context 优化对性能的影响"}),"：在大型应用中，这种优化效果更加明显"]}),e.jsxs("li",{children:["• ",e.jsx("strong",{children:"在大型应用中"}),"：这种优化效果更加明显"]})]})]})]})},xe=()=>{const[t,r]=o.useState(0),n=()=>{ie(),r(s=>s+1)};return e.jsxs("div",{className:"space-y-6",children:[e.jsxs("div",{className:"flex justify-between items-center",children:[e.jsx("h3",{className:"text-lg font-semibold text-gray-800",children:"Context 分离优化"}),e.jsx("button",{onClick:n,className:"px-3 py-1 bg-gray-500 text-white rounded text-sm hover:bg-gray-600",children:"重置计数"})]}),e.jsx(ne,{children:e.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-3 gap-4",children:[e.jsx(re,{}),e.jsx(se,{}),e.jsx(oe,{})]})},t),e.jsxs("div",{className:"bg-green-50 p-4 rounded-lg border border-green-200",children:[e.jsx("h4",{className:"font-semibold text-green-800 mb-2",children:"🔍 观察要点"}),e.jsxs("ul",{className:"text-sm text-green-700 space-y-1",children:[e.jsxs("li",{children:["• ",e.jsx("strong",{children:"状态和操作分离"}),"：减少不必要的重新渲染"]}),e.jsxs("li",{children:["• ",e.jsx("strong",{children:"只读组件不会因操作函数变化而重渲染"}),"：性能更好"]}),e.jsxs("li",{children:["• ",e.jsx("strong",{children:"操作组件很少重渲染"}),"：性能更好"]}),e.jsxs("li",{children:["• ",e.jsx("strong",{children:"每个组件只关心自己需要的部分"}),"：实现精确更新"]})]})]})]})},Ce=()=>{const[t,r]=o.useState(0),n=()=>{me(),r(s=>s+1)};return e.jsxs("div",{className:"space-y-6",children:[e.jsxs("div",{className:"flex justify-between items-center",children:[e.jsx("h3",{className:"text-lg font-semibold text-gray-800",children:"选择器模式优化"}),e.jsx("button",{onClick:n,className:"px-3 py-1 bg-gray-500 text-white rounded text-sm hover:bg-gray-600",children:"重置计数"})]}),e.jsx(ae,{children:e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-3 gap-4",children:[e.jsx(ce,{}),e.jsx(de,{}),e.jsx(le,{})]}),e.jsx("div",{className:"grid grid-cols-1 lg:grid-cols-1 gap-4",children:e.jsx(ue,{})})]})},t),e.jsxs("div",{className:"bg-purple-50 p-4 rounded-lg border border-purple-200",children:[e.jsx("h4",{className:"font-semibold text-purple-800 mb-2",children:"🔍 观察要点"}),e.jsxs("ul",{className:"text-sm text-purple-700 space-y-1",children:[e.jsxs("li",{children:["• ",e.jsx("strong",{children:"组件只订阅需要的状态片段"}),"：实现精确更新"]}),e.jsxs("li",{children:["• ",e.jsx("strong",{children:"使用 useMemo 确保选择器结果的稳定性"}),"：避免不必要的重渲染"]}),e.jsxs("li",{children:["• ",e.jsx("strong",{children:"类似 Redux 的 useSelector 模式"}),"：提供熟悉的开发体验"]}),e.jsxs("li",{children:["• ",e.jsx("strong",{children:"适合复杂状态管理场景"}),"：可以精确控制组件的重渲染时机"]})]})]})]})},P=`import {
  AppActions,
  AppContextValue,
  AppState,
  RenderCounts,
...
import {\r
  BasicAppProvider,\r
  OptimizedAppProvider,\r
  BasicConsumer,\r
  OptimizedConsumer,\r
  resetBasicCounts\r
} from './BasicContext';\r
import {\r
  SeparatedAppProvider,\r
  StateOnlyConsumer,\r
  ActionsOnlyConsumer,\r
  MixedConsumer,\r
  resetSeparatedCounts\r
} from './SeparatedContext';\r
import {\r
  SelectorAppProvider,\r
  UserSelectorConsumer,\r
  ThemeSelectorConsumer,\r
  NotificationSelectorConsumer,\r
  CompositeConsumer,\r
  resetSelectorCounts\r
} from './SelectorContext';\r
\r
// Context 基础优化对比示例\r
export const BasicContextDemo: React.FC = () => {\r
  const [resetKey, setResetKey] = useState(0);\r
  \r
  const handleReset = () => {\r
    resetBasicCounts();\r
    setResetKey(prev => prev + 1);\r
  };\r
  \r
  return (\r
    <div className="space-y-6">\r
      <div className="flex justify-between items-center">\r
        <h3 className="text-lg font-semibold text-gray-800">Context 基础优化对比</h3>\r
        <button\r
          onClick={handleReset}\r
          className="px-3 py-1 bg-gray-500 text-white rounded text-sm hover:bg-gray-600"\r
        >\r
          重置计数\r
        </button>\r
      </div>\r
      \r
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6" key={resetKey}>\r
        {/* 未优化版本 */}\r
        <BasicAppProvider>\r
          <BasicConsumer />\r
        </BasicAppProvider>\r
      ...
      <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">\r
        <h4 className="font-semibold text-blue-800 mb-2">🔍 观察要点</h4>\r
        <ul className="text-sm text-blue-700 space-y-1">\r
          <li>• <strong>点击任一按钮时</strong>：左侧组件的渲染次数会增加</li>\r
          <li>• <strong>右侧组件使用了优化</strong>：渲染次数增加较少</li>\r
          <li>• <strong>这展示了 Context 优化对性能的影响</strong>：在大型应用中，这种优化效果更加明显</li>\r
          <li>• <strong>在大型应用中</strong>：这种优化效果更加明显</li>\r
        </ul>\r
      </div>\r
    </div>\r
  );\r
...
\r
// Context 分离优化示例\r
export const ContextSeparationDemo: React.FC = () => {\r
  const [resetKey, setResetKey] = useState(0);\r
  \r
  const handleReset = () => {\r
    resetSeparatedCounts();\r
  ...
  return (\r
    <div className="space-y-6">\r
      <div className="flex justify-between items-center">\r
        <h3 className="text-lg font-semibold text-gray-800">Context 分离优化</h3>\r
        <button\r
          onClick={handleReset}\r
          className="px-3 py-1 bg-gray-500 text-white rounded text-sm hover:bg-gray-600"\r
        >\r
      ...
      \r
      <SeparatedAppProvider key={resetKey}>\r
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">\r
          <StateOnlyConsumer />\r
          <ActionsOnlyConsumer />\r
          <MixedConsumer />\r
        </div>\r
      ...
      \r
      <div className="bg-green-50 p-4 rounded-lg border border-green-200">\r
        <h4 className="font-semibold text-green-800 mb-2">🔍 观察要点</h4>\r
        <ul className="text-sm text-green-700 space-y-1">\r
          <li>• <strong>状态和操作分离</strong>：减少不必要的重新渲染</li>\r
          <li>• <strong>只读组件不会因操作函数变化而重渲染</strong>：性能更好</li>\r
          <li>• <strong>操作组件很少重渲染</strong>：性能更好</li>\r
          <li>• <strong>每个组件只关心自己需要的部分</strong>：实现精确更新</li>\r
        </ul>\r
      </div>\r
    </div>\r
  );\r
...
\r
// 选择器模式优化示例\r
export const SelectorPatternDemo: React.FC = () => {\r
  const [resetKey, setResetKey] = useState(0);\r
  \r
  const handleReset = () => {\r
    resetSelectorCounts();\r
  ...
  return (\r
    <div className="space-y-6">\r
      <div className="flex justify-between items-center">\r
        <h3 className="text-lg font-semibold text-gray-800">选择器模式优化</h3>\r
        <button\r
          onClick={handleReset}\r
          className="px-3 py-1 bg-gray-500 text-white rounded text-sm hover:bg-gray-600"\r
        >\r
      ...
      \r
      <SelectorAppProvider key={resetKey}>\r
        <div className="space-y-4">\r
          ...
          \r
          {/* 第二行：复合选择器组件 */}\r
          <div className="grid grid-cols-1 lg:grid-cols-1 gap-4">\r
            <CompositeConsumer />\r
          </div>\r
        </div>\r
      </SelectorAppProvider>\r
      ...
      <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">\r
        <h4 className="font-semibold text-purple-800 mb-2">🔍 观察要点</h4>\r
        <ul className="text-sm text-purple-700 space-y-1">\r
          <li>• <strong>组件只订阅需要的状态片段</strong>：实现精确更新</li>\r
          <li>• <strong>使用 useMemo 确保选择器结果的稳定性</strong>：避免不必要的重渲染</li>\r
          <li>• <strong>类似 Redux 的 useSelector 模式</strong>：提供熟悉的开发体验</li>\r
          <li>• <strong>适合复杂状态管理场景</strong>：可以精确控制组件的重渲染时机</li>\r
        </ul>\r
      </div>\r
    </div>\r
  );\r
...
export default {\r
  BasicContextDemo,\r
  ContextSeparationDemo,\r
  SelectorPatternDemo\r
