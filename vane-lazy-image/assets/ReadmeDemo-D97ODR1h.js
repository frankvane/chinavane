...
| 插件                             | 说明                          |
| -------------------------------- | ----------------------------- |
| \`createPriceTagPlugin\`           | 价格标签显示                  |
| \`createPromoBadgePlugin\`         | 促销角标（NEW/HOT/SALE等）    |
| \`createInventoryStatusPlugin\`    | 库存状态提示                  |
| \`createColorSwatchPlugin\`        | 颜色提取与切换                |
| \`createSocialSharePlugin\`        | 社交分享按钮                  |

### 🔨 实用工具（3 个）

| 插件                             | 说明                          |
| -------------------------------- | ----------------------------- |
| \`createVideoPosterPlugin\`        | 视频封面与播放控制            |
| \`createLocalizationPlugin\`       | 多语言图片适配                |
| \`createDownloadButtonPlugin\`     | 图片下载按钮                  |

### 🎭 视觉效果与交互（5 个）

| 插件                             | 说明                          |
| -------------------------------- | ----------------------------- |
| \`createRevealAnimationPlugin\`    | 图片揭示动画（淡入、缩放、旋转等） |
| \`createGlitchEffectPlugin\`       | 故障艺术效果（RGB分离、扫描线等） |
| \`createMorphPlugin\`              | 形变动画（弹性、液态、扭曲等） |
| \`createAnimatedCursorPlugin\`     | 自定义光标动画与交互效果       |
| \`createDepthMapPlugin\`           | 3D 视差与倾斜效果              |
