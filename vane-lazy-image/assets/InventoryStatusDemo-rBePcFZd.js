        ...
        <div>\r
          ...
          <div style={{ position: "relative", display: "inline-block" }}>\r
            <ImageWithInStock\r
              ...
              alt="有货商品"\r
              loading="lazy"\r
              containerStyle={{ width: 280, height: 280, position: "relative" }}\r
              imageStyle={{ width: "100%", height: "100%", objectFit: "cover", borderRadius: "8px" }}\r
            />\r
          </div>\r
        </div>\r
\r
      ...
      <div style={{ marginTop: 40 }}>\r
        ...
        <div style={{ position: "relative", display: "inline-block" }}>\r
          <ImageWithAutoRefresh\r
            ...
            alt="自动刷新库存"\r
            loading="lazy"\r
            containerStyle={{ width: 400, height: 300, position: "relative" }}\r
            imageStyle={{ width: "100%", height: "100%", objectFit: "cover", borderRadius: "8px" }}\r
          />\r
        </div>\r
      </div>\r
