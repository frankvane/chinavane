const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./BasicThemeExample-DZKJXR1x.js","./index-H7t66yxh.js","./index-BFRj4jJ-.css","./AuthenticationExample-KvmPcNuV.js","./ShoppingCartExample-Cr1XFBsO.js"])))=>i.map(i=>d[i]);
import{j as t,R as e,_ as n}from"./index-H7t66yxh.js";import{C as r}from"./ComponentTemplate-bNJaV0ol.js";const i=`import React, { createContext, useCallback, useContext, useMemo, useState } from 'react';
