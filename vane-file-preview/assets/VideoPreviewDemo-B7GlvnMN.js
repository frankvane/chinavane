...
\r
export default function VideoPreviewDemo() {\r
  const [selectedFile, setSelectedFile] = useState<FileInfo>(videoFiles[0]);\r
\r
  // 创建视频预览组件\r
...
\r
  return (\r
    <DemoPage\r
      title="视频预览"\r
      description="展示视频文件的预览功能，支持 MP4、WebM 等格式，提供完整的播放控制"\r
    >\r
      <div\r
        style={{\r
          display: "flex",\r
      ...
      >\r
        ...
        >\r
          <h3 style={{ margin: "0 0 16px", fontSize: 16 }}>视频文件</h3>\r
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>\r
            {videoFiles.map((file, index) => (\r
              <button\r
                key={index}\r
