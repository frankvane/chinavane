...
\r
export default function EpubPreviewDemo() {\r
  const [selectedFile, setSelectedFile] = useState<FileInfo>(epubFiles[0]);\r
\r
  // 创建EPUB预览组件\r
...
\r
  return (\r
    <DemoPage\r
      title="EPUB预览"\r
      description="展示EPUB电子书的预览功能，支持电子书阅读、目录导航等功能"\r
    >\r
      <div\r
        style={{\r
          display: "flex",\r
      ...
      >\r
        ...
        >\r
          <h3 style={{ margin: "0 0 16px", fontSize: 16 }}>EPUB文件</h3>\r
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>\r
            {epubFiles.map((file, index) => (\r
              <button\r
                key={index}\r
