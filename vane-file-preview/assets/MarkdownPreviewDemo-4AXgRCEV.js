...
\r
// 示例Markdown文件列表\r
const markdownFiles: FileInfo[] = [\r
  {\r
    name: "sample.md",\r
    size: 188 * 1024,\r
...
\r
export default function MarkdownPreviewDemo() {\r
  const [selectedFile, setSelectedFile] = useState<FileInfo>(markdownFiles[0]);\r
\r
  // 创建Markdown预览组件\r
...
\r
  return (\r
    <DemoPage\r
      title="Markdown预览"\r
      description="展示Markdown文件的预览功能，支持GitHub风格语法、数学公式、代码高亮等功能"\r
    >\r
      <div\r
        style={{\r
          display: "flex",\r
      ...
      >\r
        ...
        >\r
          <h3 style={{ margin: "0 0 16px", fontSize: 16 }}>Markdown文件</h3>\r
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>\r
            {markdownFiles.map((file, index) => (\r
              <button\r
                key={index}\r
