const n=`import { LazyLoadImageCore, createWatermarkPlugin, withPlugins } from "vane-lazy-image";
...
export default function BasicDemo() {
  ...
  return (
    <DemoPage
      ...
      description="在瀑布流中渲染 vane-card 卡片（图片/标题/价格/文案）以及 vane-lazy-image图片懒加载。"
    >
      <div
        style={{
          height: "600px",
            ...
            >
              ...
              >
                 <LazyImage
                  src={item.image}
                  loading="lazy"
                  containerStyle={{ width: "100%", height: item.height }}
                  imageStyle={{ width: "100%", height: item.height, objectFit: "cover" }}
                />
